...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:WC="wgcontrols" xmlns:WG="http://www.gizmox.com/webgui">
  ...
  <xsl:template match="WC:Tags.StatusStrip[not(@Attr.CustomStyle)]" mode="modContent">
    ...
    <xsl:call-template name="tplDrawToolStripAPI">
      ...
      <xsl:with-param name="prmContentClass" select="'ToolStrip-Content'"/>
  ...
  <xsl:template match="WC:Tags.StatusStrip[not(@Attr.CustomStyle)]" mode="modFrameCenterContent">
    <xsl:call-template name="tplDrawToolStripCenterFrameAPI">
      ...
      <xsl:with-param name="prmAllowWrapContents" select="'0'"/>
  ...
  <xsl:template match="WC:Tags.StatusStrip[not(@Attr.CustomStyle)]" mode="modApplyStyle">
