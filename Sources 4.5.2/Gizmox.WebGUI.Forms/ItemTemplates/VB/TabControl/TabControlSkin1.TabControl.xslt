...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="WC:Tags.TabControl[@Attr.CustomStyle='$safeitemname$' and not(@Attr.Appearance='32')]" mode="modContent">
  ...
  <xsl:template match="WC:Tags.TabControl[@Attr.CustomStyle='$safeitemname$' and @Attr.Appearance='32']" mode="modContent">
    <xsl:param name="prmIsEnabled" />
    <xsl:call-template name="tplDrawTabControlAPI" >
      <xsl:with-param name="prmControlClass" select="'TabControl-Control'"/>
