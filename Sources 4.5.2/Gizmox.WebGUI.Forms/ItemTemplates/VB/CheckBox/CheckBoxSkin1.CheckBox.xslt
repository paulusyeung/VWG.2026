...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="WC:Tags.CheckBox[@Attr.CustomStyle='$safeitemname$']" mode="modContent">
  ...
  <xsl:template match="WC:Tags.CheckBox[@Attr.CustomStyle='$safeitemname$' and @Attr.Appearance='1']" mode="modContent">
    <xsl:param name="prmIsEnabled" />
  ...
  <xsl:template match="WC:Tags.CheckBox[@Attr.CustomStyle='$safeitemname$' and @Attr.Appearance='1']" mode="modFrameCenterContent">
