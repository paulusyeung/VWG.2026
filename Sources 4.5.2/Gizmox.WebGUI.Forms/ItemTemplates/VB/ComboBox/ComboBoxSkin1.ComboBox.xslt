...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="WC:Tags.ComboBox[@Attr.CustomStyle='$safeitemname$']" mode="modContent">
  ...
  <xsl:template match="Tags.Options[../@Attr.CustomStyle='$safeitemname$']" >
    <xsl:param name="prmIsEnabled">
  ...
  <xsl:template match="Tags.Options[../@Attr.CustomStyle='$safeitemname$']" mode="modFrameCenterContent">
    <xsl:param name="prmIsEnabled" />
  ...
  <xsl:template match="WC:Tags.ComboBox[@Attr.CustomStyle='$safeitemname$']" mode="modApplyAttributes">
