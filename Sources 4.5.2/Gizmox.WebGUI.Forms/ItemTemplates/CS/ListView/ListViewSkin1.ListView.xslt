...
<xsl:stylesheet version="1.0"
	...
	xmlns:WC="wgcontrols">
  <!-- Details Mode -->
  <xsl:template match="WC:Tags.ListView[@Attr.View='Details' and @Attr.CustomStyle='$safeitemname$' and not(@Attr.Appearance)]" mode="modContent">
    ...
    <xsl:call-template name="tplListViewDrawDetailsAPI" >
      ...
      <xsl:with-param name="prmListViewPagingGoToBoxClass" select="'ListView-PagingGoToBox'" />
      <xsl:with-param name="prmListViewPagingNumberSeperatorString" select="'[Skin.PagingNumberSeperatorFormat]'"/>
  ...
  <!-- List Mode -->
  <xsl:template match="WC:Tags.ListView[@Attr.View='List' and @Attr.CustomStyle='$safeitemname$' and not(@Attr.Appearance)]" mode="modContent">
    <xsl:param name="prmIsEnabled" />
  ...
  <!-- Small icons Mode -->
  <xsl:template match="WC:Tags.ListView[@Attr.View='SmallIcon' and @Attr.CustomStyle='$safeitemname$' and not(@Attr.Appearance)]" mode="modContent">
    <xsl:param name="prmIsEnabled" />
  ...
  <!-- Large icons Mode -->
  <xsl:template match="WC:Tags.ListView[@Attr.View='LargeIcon' and @Attr.CustomStyle='$safeitemname$' and not(@Attr.Appearance)]" mode="modContent">
    <xsl:param name="prmIsEnabled" />
  ...
  <xsl:template match="WC:Tags.ListView[@Attr.View='Details' and @Attr.CustomStyle='$safeitemname$' and not(@Attr.Appearance)]" mode="modListViewDetailedColumns">
  ...
  <xsl:template match="WC:Tags.ListView[@Attr.View='Details' and @Attr.CustomStyle='$safeitemname$' and not(@Attr.Appearance)]" mode="modListViewDetailedHeader">
  ...
  <xsl:template match="Tags.Group[../@Attr.CustomStyle='$safeitemname$' and not(../@Attr.Appearance)]" mode="modListViewGroupHeader">
  ...
  <xsl:template match="WC:Tags.ListView[not(@Attr.Appearance) and @Attr.CustomStyle='$safeitemname$']" mode="modListViewDetailsTableBodyRowRender">
    <xsl:param name="prmListViewFontDataClass" />
  ...
  <xsl:template match="Tags.Row[../@Attr.CustomStyle='$safeitemname$' and not(../@Attr.Appearance)]" mode="modListViewDetailedItemRow">
    <xsl:param name="prmListViewCheckBoxImageClass" />
    <xsl:param name="prmListViewCellClass" />
    <xsl:param name="prmListViewItemCellClass" />
    <xsl:param name="prmListViewDataCellClass" />
  ...
  <xsl:template match="Tags.Row[../@Attr.View='List' and @Attr.CustomStyle='$safeitemname$']">
  ...
  <xsl:template match="Tags.Row[../@Attr.View='SmallIcon' and @Attr.CustomStyle='$safeitemname$']">
    <xsl:param name="prmListViewFontDataClass" select="'ListView-FontData'" />
    <xsl:param name="prmListViewCheckBoxImageClass"  select="'ListView-CheckBoxImage'" />
  ...
  <xsl:template match="Tags.Row[../@Attr.View='LargeIcon' and @Attr.CustomStyle='$safeitemname$']">
    <xsl:param name="prmListViewFontDataClass" select="'ListView-FontData'" />
    <xsl:param name="prmListViewCheckBoxImageClass"  select="'ListView-CheckBoxImage'" />
