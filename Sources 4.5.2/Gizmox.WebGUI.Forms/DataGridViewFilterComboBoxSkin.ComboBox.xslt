...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="WC:Tags.ComboBox[@Attr.CustomStyle='DataGridViewFilterComboBox']" mode="modContent">
  ...
  <xsl:template match="Tags.Options[../@Attr.CustomStyle='DataGridViewFilterComboBox']" >
    <xsl:param name="prmIsEnabled">
  ...
  <xsl:template match="Tags.Options[../@Attr.CustomStyle='DataGridViewFilterComboBox']" mode="modFrameCenterContent">
    <xsl:param name="prmIsEnabled" />
