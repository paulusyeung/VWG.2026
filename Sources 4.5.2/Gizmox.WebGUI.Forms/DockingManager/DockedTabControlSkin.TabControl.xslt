...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="WC:Tags.TabControl[@Attr.CustomStyle='DockedTabContolSkin']" mode="modTraceableEvents">
    <xsl:attribute name="data-vwg_AfterCreateEventHandler">mobjApp.DockedTabControl_AfterCreateTabControlEvents</xsl:attribute>
  </xsl:template>
  
  <xsl:template match="WC:Tags.TabControl[@Attr.CustomStyle='DockedTabContolSkin']" mode="modContent">
