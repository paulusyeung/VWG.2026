...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="WC:Tags.Label[@Attr.CustomStyle='AdministrationHeaderLabelSkin']" mode="modContent">
  ...
  <xsl:template match="WC:Tags.Label[@Attr.CustomStyle='AdministrationHeaderLabelSkin']" mode="modContentText">
