...
namespace Gizmox.WebGUI.Forms.Skins
{
    ...
    /// RadioButton Skin
    /// </summary>
    [ToolboxBitmapAttribute(typeof(RadioButton), "RadioButton.bmp"), Serializable()]
    public class RadioButtonSkin : Gizmox.WebGUI.Forms.Skins.ButtonBaseSkin
    {
        ...
        #region Normal apperance

        /// <summary>
        /// Gets or sets the checked Radio buttons image.
        /// </summary>
        /// <value>The checked Radio buttons image.</value>
        [SRDescription("The checked Radio image.")]
        [SRCategory("Images")]
        public ImageResourceReference CheckedRadioImage
        {
            get
            {
                return this.GetValue<ImageResourceReference>("CheckedRadioImage", new ImageResourceReference(typeof(RadioButtonSkin), "Radio1.gif"));
            }
            set
            {
                this.SetValue("CheckedRadioImage", value);
            }
        }

        /// <summary>
        /// Resets the checked Radio buttons image.
        /// </summary>
        private void ResetCheckedRadioImage()
        {
            this.Reset("CheckedRadioImage");
        }

        /// <summary>
        /// Gets or sets the un checked Radio buttons image.
        /// </summary>
        /// <value>The un checked Radio buttons image.</value>
        [SRDescription("The unchecked Radio image.")]
        [SRCategory("Images")]
        public ImageResourceReference UnCheckedRadioImage
        {
            get
            {
                return this.GetValue<ImageResourceReference>("UnCheckedRadioImage", new ImageResourceReference(typeof(RadioButtonSkin), "Radio0.gif"));
            }
            set
            {
                this.SetValue("UnCheckedRadioImage", value);
            }
        }

        /// <summary>
        /// Resets the un checked Radio buttons image.
        /// </summary>
        private void ResetUnCheckedRadioImage()
        {
            this.Reset("UnCheckedRadioImage");
        }

        /// <summary>
        /// Gets the height of the radio image.
        /// </summary>
        /// <value>The height of the radio image.</value>
        [Browsable(false)]
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual int RadioImageHeight
        {
            get
            {
                return this.GetMaxImageHeight(this.DefaultRadioImageHeight, UnCheckedRadioImage.ResourceName, CheckedRadioImage.ResourceName);
            }
        }
        ...
        /// </summary>
        internal void ResetRadioImageHeight()
        {
            this.Reset("RadioImageHeight");
        }

        /// <summary>
        /// Gets default value
        /// </summary>
        protected virtual int DefaultRadioImageHeight
        {
            get
            {
                return 13;
        ...
        /// <summary>
        /// Gets the width of the radio image.
        /// </summary>
        /// <value>The width of the radio image.</value>
        [Browsable(false)]
        [EditorBrowsable(EditorBrowsableState.Never)]
        public int RadioImageWidth
        {
            get
            {
                return this.GetMaxImageWidth(this.DefaultRadioImageWidth, UnCheckedRadioImage.ResourceName, CheckedRadioImage.ResourceName);
            }
        }
        ...
        /// Resets the height value
        /// </summary>
        internal void ResetRadioImageWidth()
        {
            this.Reset("RadioImageWidth");
        }

        /// <summary>
        /// Gets default value
        /// </summary>
        protected virtual int DefaultRadioImageWidth
        {
            get
            {
                return 13;
        ...
        #region TextNormalStyle

        /// <summary>
        /// Gets the center normal style.
        /// </summary>
        /// <value>The center normal style.</value>
        [Category("States"), Description("The radio button's text normal style.")]
        public virtual StyleValue TextNormalStyle
        {
            get
            {
                StyleValue objStyle = new StyleValue(this, "TextNormalStyle");
                return objStyle;
            }
        }
        ...
        #region TextFocusedStyle

        /// <summary>
        /// Gets the center focused style.
        /// </summary>
        /// <value>The center focused style.</value>
        [Category("States"), Description("The radio button's text focused style.")]
        public virtual StyleValue TextFocusedStyle
        {
            get
            {
                StyleValue objStyle = new StyleValue(this, "TextFocusedStyle");
                return objStyle;
            }
        }
