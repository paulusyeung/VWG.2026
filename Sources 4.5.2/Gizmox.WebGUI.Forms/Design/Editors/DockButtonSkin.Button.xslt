...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="WC:Tags.Button[@Attr.CustomStyle='DockButtonSkin']" mode="modContent">
  ...
  <xsl:template match="WC:Tags.Button[@Attr.CustomStyle='DockButtonSkin']" mode="modFrameCenterContent">
