...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:WC="wgcontrols" xmlns:WG="http://www.gizmox.com/webgui">
  ...
  <xsl:template match="WC:Tags.MenuStrip[not(@Attr.CustomStyle)]" mode="modContent">
  ...
  <xsl:template match="WC:Tags.MenuStrip[not(@Attr.CustomStyle)]" mode="modFrameCenterContent">
  ...
  <xsl:template match="WC:Tags.MenuStrip[not(@Attr.CustomStyle)]" mode="modApplyStyle">
