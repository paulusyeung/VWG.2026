...
namespace Gizmox.WebGUI.Forms
{
    ...
    {
        public HeaderLabelVisualTemplate()
        {            
        }
        ...
        public override string VisualTemplateName
        {
            get
            {
                return "HeaderLabelVisualTemplate";
            }
        }
        ...
        public override Common.Resources.ResourceHandle VisualizerImage
        {
            get
            {
                return new SkinResourceHandle(typeof(HeaderLabelVisualTemplateSkin), "LableHeaderTemplate.png");
            }
        }
