...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="WC:Tags.Label[@Attr.VisualTemplate='HeaderLabelVisualTemplate' and not(@Attr.CustomStyle)]" mode="modContent">
  ...
  <xsl:template match="WC:Tags.Label[@Attr.VisualTemplate='HeaderLabelVisualTemplate' and not(@Attr.CustomStyle)]" mode="modContentText">
  ...
  <xsl:template match="WC:Tags.Label[@Attr.VisualTemplate='HeaderLabelVisualTemplate' and not(@Attr.CustomStyle)]" mode="modApplyStyle">
