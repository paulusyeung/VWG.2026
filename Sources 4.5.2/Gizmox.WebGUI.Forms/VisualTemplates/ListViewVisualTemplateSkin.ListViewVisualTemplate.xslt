...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:WC="wgcontrols" xmlns:WG="http://www.gizmox.com/webgui">
  ...
  <xsl:template match="WC:Tags.ListView[@Attr.View='Details' and @Attr.VisualTemplate='ListViewVisualTemplate' and not(@Attr.CustomStyle)]" mode="modContent">
    <xsl:param name="prmIsEnabled" />

    <xsl:call-template name="tplListViewDrawDetailsAPI" >
      <xsl:with-param name="prmIsEnabled" select="$prmIsEnabled" />
      <xsl:with-param name="prmHeaders">
        <xsl:choose>
          <xsl:when test="@Attr.VisualTemplateListViewItemRowTemplate='ContactList'">0</xsl:when>
          <xsl:otherwise><xsl:value-of select="not(@Attr.HeaderStyle='0')"/></xsl:otherwise>
        </xsl:choose>
      </xsl:with-param>
    </xsl:call-template>
  </xsl:template>
  ...
  <!-- BODY RENDER -->
  <!-- Main body for the items for the VisualTemplate -->
  <xsl:template match="WC:Tags.ListView[@Attr.VisualTemplate='ListViewVisualTemplate' and not(@Attr.CustomStyle)]" mode="modListViewDetailsTableBodyRowRender">
  ...
  <!-- Single row render for the VisualTemplate - This will call the specific behavior related to the VisualTemplate -->
  <xsl:template match="Tags.Row[../@Attr.VisualTemplate='ListViewVisualTemplate' and not(../@Attr.CustomStyle)]" mode="modListViewDetailedItemRow">
    <xsl:param name="prmListViewCheckBoxImageClass" />
    <xsl:param name="prmListViewCellClass" />
    <xsl:param name="prmListViewItemCellClass" />
    <xsl:param name="prmListViewDataCellClass" />
  ...
  <xsl:template match="WC:Tags.ListView[@Attr.VisualTemplate='ListViewVisualTemplate' and not(@Attr.CustomStyle)]" mode="modListViewDetailedColumns">
  ...
  <!-- Original column order render for the VisualTemplate -->
  <xsl:template match="WC:Tags.ListView[@Attr.VisualTemplate='ListViewVisualTemplate' and @Attr.VisualTemplateListViewItemRowTemplate='None' and not(@Attr.VisualTemplateListViewNewColumnOrder) and not(@Attr.CustomStyle)]" mode="modListViewDetailedColumnsVisualTemplate">
    <xsl:param name="prmListViewColumnSeperatorClass" />
    <xsl:param name="prmListViewSortedColumnClass" />
    <xsl:param name="prmCheckBoxes" />
    <xsl:param name="prmCols" />
  ...
  <!-- New column order render for the VisualTemplate -->
  <xsl:template match="WC:Tags.ListView[@Attr.VisualTemplate='ListViewVisualTemplate' and @Attr.VisualTemplateListViewItemRowTemplate='None' and (string-length(@Attr.VisualTemplateListViewNewColumnOrder) &gt; 0) and not(@Attr.CustomStyle)]" mode="modListViewDetailedColumnsVisualTemplate">
    <xsl:param name="prmListViewColumnSeperatorClass" />
    <xsl:param name="prmListViewSortedColumnClass" />
    <xsl:param name="prmCheckBoxes" />
    <xsl:param name="prmCols" />
  ...
  <xsl:template match="WC:Tags.ListView[@Attr.VisualTemplate='ListViewVisualTemplate' and @Attr.VisualTemplateListViewItemRowTemplate='ContactList' and not(@Attr.CustomStyle)]" mode="modListViewDetailedColumnsVisualTemplate">
    <xsl:param name="prmCheckBoxes" />
    <xsl:param name="prmColIdBase" />
  ...
  <xsl:template match="WC:Tags.ListView[@Attr.VisualTemplate='ListViewVisualTemplate' and not(@Attr.CustomStyle)]" mode="modListViewDetailedHeader">
    <xsl:param name="prmListViewFontDataClass" />
  ...
  <xsl:template match="WC:Tags.ListView[@Attr.VisualTemplate='ListViewVisualTemplate' and @Attr.VisualTemplateListViewItemRowTemplate='None' and not(@Attr.VisualTemplateListViewNewColumnOrder) and not(@Attr.CustomStyle)]" mode="modListViewDetailedHeaderVisualTemplate">
    <xsl:param name="prmListViewFontDataClass" />
    <xsl:param name="prmListViewHeaderCellClass" />
    <xsl:param name="prmListViewHeaderSeperatorClass" />
    <xsl:param name="prmCols" />
  ...
  <xsl:template match="WC:Tags.ListView[@Attr.VisualTemplate='ListViewVisualTemplate' and @Attr.VisualTemplateListViewItemRowTemplate='None' and (string-length(@Attr.VisualTemplateListViewNewColumnOrder) &gt; 0) and not(@Attr.CustomStyle)]" mode="modListViewDetailedHeaderVisualTemplate">
    <xsl:param name="prmListViewFontDataClass" />
    <xsl:param name="prmListViewHeaderCellClass" />
    <xsl:param name="prmListViewHeaderSeperatorClass" />
    <xsl:param name="prmCols" />
  ...
  <xsl:template match="WC:Tags.ListView[@Attr.VisualTemplate='ListViewVisualTemplate' and @Attr.VisualTemplateListViewItemRowTemplate='ContactList' and not(@Attr.CustomStyle)]" mode="modListViewDetailedHeaderVisualTemplate">
    <xsl:param name="prmListViewFontDataClass" />
    <xsl:param name="prmListViewHeaderCellClass" />
    <xsl:param name="prmListViewHeaderSeperatorClass" />
    <xsl:param name="prmCols" />
  ...
  <!-- GROUP RENDER -->
  <xsl:template match="Tags.Group[../@Attr.VisualTemplate='ListViewVisualTemplate' and not(../@Attr.CustomStyle)]" mode="modListViewGroupHeader">
    <xsl:param name="prmListViewFontGroupHeaderSeperatorClass" />
  ...
  <xsl:template match="Tags.Group[../@Attr.VisualTemplate='ListViewVisualTemplate' and ../@Attr.VisualTemplateListViewItemRowTemplate='None' and not(../@Attr.CustomStyle)]" mode="modListViewDetailedGroupRowVisualTemplate">
    <xsl:param name="prmListViewFontGroupHeaderSeperatorClass" />
  ...
  <xsl:template match="Tags.Group[../@Attr.VisualTemplate='ListViewVisualTemplate' and ../@Attr.VisualTemplateListViewItemRowTemplate='ContactList' and not(../@Attr.CustomStyle)]" mode="modListViewDetailedGroupRowVisualTemplate">
    <xsl:param name="prmListViewGroupHeaderClass" />
    <xsl:param name="prmListViewFontGroupHeaderSeperatorClass" />
  ...
  <!-- SINGLE ROW RENDER-->
  <!-- Match will happen when no row template was supplied and the rows are in the original order -->
  <xsl:template match="Tags.Row[../@Attr.VisualTemplate='ListViewVisualTemplate' and ../@Attr.VisualTemplateListViewItemRowTemplate='None' and not(../@Attr.VisualTemplateListViewNewColumnOrder) and not(../@Attr.CustomStyle)]" mode="modListViewDetailedItemRowVisualTemplate">
    <xsl:param name="prmListViewCheckBoxImageClass" />
    <xsl:param name="prmListViewCellClass" />
    <xsl:param name="prmListViewItemCellClass" />
    <xsl:param name="prmListViewDataCellClass" />
  ...
  <!-- Match will happen when no row template was supplied and the rows are in a new order -->
  <xsl:template match="Tags.Row[../@Attr.VisualTemplate='ListViewVisualTemplate' and ../@Attr.VisualTemplateListViewItemRowTemplate='None' and (string-length(../@Attr.VisualTemplateListViewNewColumnOrder) &gt; 0) and not(../@Attr.CustomStyle)]" mode="modListViewDetailedItemRowVisualTemplate">
    <xsl:param name="prmListViewCheckBoxImageClass" />
    <xsl:param name="prmListViewCellClass" />
    <xsl:param name="prmListViewItemCellClass" />
    <xsl:param name="prmListViewDataCellClass" />
  ...
  <!-- Match will happen when 'CONTACTLIST' row template is requested -->
  <xsl:template match="Tags.Row[../@Attr.VisualTemplate='ListViewVisualTemplate' and ../@Attr.VisualTemplateListViewItemRowTemplate='ContactList' and not(../@Attr.CustomStyle)]" mode="modListViewDetailedItemRowVisualTemplate">
    <xsl:param name="prmListViewCheckBoxImageClass" />
    <xsl:param name="prmListViewCellClass" />
    <xsl:param name="prmListViewItemCellClass" />
    <xsl:param name="prmListViewDataCellClass" />
  ...
  <xsl:template match="WC:Tags.ListView[@Attr.VisualTemplate='ListViewVisualTemplate' and @Attr.VisualTemplateListViewItemRowTemplate='ContactList' and not(@Attr.CustomStyle)]" mode="modListViewDetailedItemRowColumnsNumberVisualTemplate">
    <xsl:param name="prmCheckBoxes"/>
