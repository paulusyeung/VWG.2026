...
{
    public partial class VideoExample : UserControl
    {
        ...
        {
            VideoCaptureOptions objImageCaptureOptions = new VideoCaptureOptions();
            objImageCaptureOptions.Limit = 1;

            mobjDevice.Capture.CaptureVideo(objImageCaptureOptions, VideoCaptured);
        }

        public void VideoCaptured(CaptureEventArgs objCaptureEventArgs)
        {
