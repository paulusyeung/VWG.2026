...
Visual WebGui - Catalog Overview
====================================================

1. Directories 
--------------------------------------------------------------------------------------------------------
\SEO		- Classes that structure the catalog application and provide visibility for search engines.
\UI			- Classes that support the catalog specific requirements for usability and design
\Controls	- Controls related features and samples.
\Concepts	- Concepts related features and samples.

2. Custom Controls
--------------------------------------------------------------------------------------------------------
User Related Controls:
\UI\NavigationView.cs	- Provides a lightweight implementation of the catalog navigation framework and it's 
					      basic design.
					      
Admin Related Controls:					      
\UI\NavigationTree.cs	- Provides support for displaying a tree view populated with SEO navigation nodes.
\UI\NavigationCombo.cs 	- Provides support for selecting a single navigation node using a tree drop down
\UI\EditView.cs			- Provides base class support for editing or creating a seo navigation items.
\UI\CreateView.cs		- Provides base class support for creating a seo navigation items.
\UI\PageEditView.cs		- Provides base class support for editing pages.
\UI\FolderEditView.cs	- Provides base class support for editing folders.
