...
Namespace Gizmox.WebGUI.Forms.CompanionKit.WebSocketsSampleAppsVB
    ...
    Partial Class DynamicDataForm
        ...
        Private Sub InitializeComponent()
            Me.mobjProgressBar1 = New ProgressBar()
            Me.mobjProgressBar2 = New ProgressBar()
            Me.mobjProgressBar3 = New ProgressBar()
            Me.mobjProgressBar4 = New ProgressBar()
            Me.mobjProgressBar5 = New ProgressBar()
            Me.mobjLayoutPanel = New TableLayoutPanel()
            Me.mobjInfoLabel = New Label()
            Me.mobjAdditionalLayoutPanel = New TableLayoutPanel()
            Me.mobjLabel5 = New Label()
            Me.mobjLabel4 = New Label()
            Me.mobjLabel3 = New Label()
            Me.mobjLabel2 = New Label()
            Me.mobjLabel1 = New Label()
            ...
            Me.mobjProgressBar1.Dock = DockStyle.Fill
            ...
            Me.mobjProgressBar2.Dock = DockStyle.Fill
            ...
            Me.mobjProgressBar3.Dock = DockStyle.Fill
            ...
            Me.mobjProgressBar4.Dock = DockStyle.Fill
            ...
            Me.mobjProgressBar5.Dock = DockStyle.Fill
            ...
            Me.mobjLayoutPanel.ColumnStyles.Add(New ColumnStyle(SizeType.Percent, 50.0F))
            Me.mobjLayoutPanel.ColumnStyles.Add(New ColumnStyle(SizeType.Absolute, 60.0F))
            Me.mobjLayoutPanel.ColumnStyles.Add(New ColumnStyle(SizeType.Absolute, 60.0F))
            Me.mobjLayoutPanel.ColumnStyles.Add(New ColumnStyle(SizeType.Absolute, 60.0F))
            Me.mobjLayoutPanel.ColumnStyles.Add(New ColumnStyle(SizeType.Absolute, 60.0F))
            Me.mobjLayoutPanel.ColumnStyles.Add(New ColumnStyle(SizeType.Absolute, 60.0F))
            ...
            Me.mobjLayoutPanel.RowStyles.Add(New RowStyle(SizeType.Percent, 50.0F))
            Me.mobjLayoutPanel.RowStyles.Add(New RowStyle(SizeType.Absolute, 30.0F))
            Me.mobjLayoutPanel.RowStyles.Add(New RowStyle(SizeType.Absolute, 30.0F))
            Me.mobjLayoutPanel.RowStyles.Add(New RowStyle(SizeType.Absolute, 300.0F))
            Me.mobjLayoutPanel.RowStyles.Add(New RowStyle(SizeType.Percent, 50.0F))
            Me.mobjLayoutPanel.Size = New System.Drawing.Size(852, 391)
            Me.mobjLayoutPanel.TabIndex = 2
            Me.mobjLayoutPanel.VisualEffect = New VisualEffects.EmptyVisualEffect()
            ' 
            ' mobjInfoLabel
            ' 
            ...
            Me.mobjAdditionalLayoutPanel.ColumnStyles.Add(New ColumnStyle(SizeType.Percent, 100.0F))
            ...
            Me.mobjAdditionalLayoutPanel.Dock = DockStyle.Fill
            ...
            Me.mobjAdditionalLayoutPanel.RowStyles.Add(New RowStyle(SizeType.Absolute, 15.0F))
            Me.mobjAdditionalLayoutPanel.RowStyles.Add(New RowStyle(SizeType.Absolute, 30.0F))
            Me.mobjAdditionalLayoutPanel.RowStyles.Add(New RowStyle(SizeType.Absolute, 30.0F))
            Me.mobjAdditionalLayoutPanel.RowStyles.Add(New RowStyle(SizeType.Absolute, 30.0F))
            Me.mobjAdditionalLayoutPanel.RowStyles.Add(New RowStyle(SizeType.Absolute, 30.0F))
            Me.mobjAdditionalLayoutPanel.RowStyles.Add(New RowStyle(SizeType.Absolute, 30.0F))
            ...
            Me.mobjAdditionalLayoutPanel.VisualEffect = New VisualEffects.TransformVisualEffect(New VisualEffects.Transformation() {New VisualEffects.Transformation(VisualEffects.TransformType.Rotate, 270.0F, New VisualEffects.Matrix(1.0F, 0.0F, 0.0F, 1.0F, 0.0F, 0.0F), Nothing, Nothing, New VisualEffects.AxisValue(), _
             New VisualEffects.AxisLengthAndUnits(VisualEffects.LengthUnits.Pixel, VisualEffects.LengthUnits.Pixel, VisualEffects.LengthUnits.Pixel, Nothing, Nothing, Nothing))}, New VisualEffects.Location(VisualEffects.HorizontalDirection.None, VisualEffects.LengthUnits.Percent, VisualEffects.VerticalDirection.None, VisualEffects.LengthUnits.Percent, 50.0F, 50.0F))
            ' 
            ' mobjLabel5
            ' 
            Me.mobjLabel5.AutoSize = True
            Me.mobjLabel5.ClientId = "Label5"
            Me.mobjLabel5.Dock = DockStyle.Fill
            ...
            Me.mobjLabel4.Dock = DockStyle.Fill
            ...
            Me.mobjLabel3.Dock = DockStyle.Fill
            ...
            Me.mobjLabel2.Dock = DockStyle.Fill
            ...
            Me.mobjLabel1.Dock = DockStyle.Fill
            ...
            Me.Text = "DynamicData"
            Me.VisualEffect = New VisualEffects.EmptyVisualEffect()
        ...
        Private mobjLabel1 As Label
        Private mobjLabel2 As Label
        Private mobjLabel3 As Label
        Private mobjLabel4 As Label
        Private mobjLabel5 As Label
        Private mobjLayoutPanel As TableLayoutPanel
        Friend mobjAdditionalLayoutPanel As TableLayoutPanel
        Friend mobjProgressBar1 As ProgressBar
        Friend mobjProgressBar2 As ProgressBar
        Friend mobjProgressBar3 As ProgressBar
        Friend mobjProgressBar4 As ProgressBar
        Friend mobjProgressBar5 As ProgressBar
        Private mobjInfoLabel As Label
