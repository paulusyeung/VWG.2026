...
Namespace OfflineModeSampleAppVB
    ...
    Partial Class OfflineModeForm
        ...
        Private Sub InitializeComponent()
            ...
            Me.mobjStatusStrip = New Gizmox.WebGUI.Forms.StatusStrip()
            Me.mobjToolStripStatusLabel = New Gizmox.WebGUI.Forms.ToolStripStatusLabel()
            Me.mobjLayoutPanel = New Gizmox.WebGUI.Forms.TableLayoutPanel()
            Me.mobjLogTextBox = New Gizmox.WebGUI.Forms.TextBox()
            ...
            Me.mobjStatusStrip.Dock = Gizmox.WebGUI.Forms.DockStyle.Bottom
            Me.mobjStatusStrip.DockPadding.Left = 1
            Me.mobjStatusStrip.DockPadding.Right = 14
            Me.mobjStatusStrip.Items.AddRange(New Gizmox.WebGUI.Forms.ToolStripItem() {Me.mobjToolStripStatusLabel})
            ...
            Me.mobjToolStripStatusLabel.Margin = New Gizmox.WebGUI.Forms.Padding(0, 1, 0, 2)
            ...
            Me.mobjLayoutPanel.ColumnStyles.Add(New Gizmox.WebGUI.Forms.ColumnStyle(Gizmox.WebGUI.Forms.SizeType.Absolute, 20.0!))
            Me.mobjLayoutPanel.ColumnStyles.Add(New Gizmox.WebGUI.Forms.ColumnStyle(Gizmox.WebGUI.Forms.SizeType.Percent, 50.0!))
            Me.mobjLayoutPanel.ColumnStyles.Add(New Gizmox.WebGUI.Forms.ColumnStyle(Gizmox.WebGUI.Forms.SizeType.Absolute, 128.0!))
            Me.mobjLayoutPanel.ColumnStyles.Add(New Gizmox.WebGUI.Forms.ColumnStyle(Gizmox.WebGUI.Forms.SizeType.Percent, 50.0!))
            Me.mobjLayoutPanel.ColumnStyles.Add(New Gizmox.WebGUI.Forms.ColumnStyle(Gizmox.WebGUI.Forms.SizeType.Absolute, 20.0!))
            ...
            Me.mobjLayoutPanel.RowStyles.Add(New Gizmox.WebGUI.Forms.RowStyle(Gizmox.WebGUI.Forms.SizeType.Absolute, 128.0!))
            Me.mobjLayoutPanel.RowStyles.Add(New Gizmox.WebGUI.Forms.RowStyle(Gizmox.WebGUI.Forms.SizeType.Percent, 50.0!))
            Me.mobjLayoutPanel.RowStyles.Add(New Gizmox.WebGUI.Forms.RowStyle(Gizmox.WebGUI.Forms.SizeType.Absolute, 40.0!))
            Me.mobjLayoutPanel.RowStyles.Add(New Gizmox.WebGUI.Forms.RowStyle(Gizmox.WebGUI.Forms.SizeType.Absolute, 200.0!))
            Me.mobjLayoutPanel.RowStyles.Add(New Gizmox.WebGUI.Forms.RowStyle(Gizmox.WebGUI.Forms.SizeType.Percent, 50.0!))
            ...
            Me.mobjLogTextBox.Dock = Gizmox.WebGUI.Forms.DockStyle.Fill
            ...
            Me.mobjLogTextBox.ScrollBars = Gizmox.WebGUI.Forms.ScrollBars.Vertical
        ...
        Private mobjStatusStrip As Gizmox.WebGUI.Forms.StatusStrip
        Private mobjToolStripStatusLabel As Gizmox.WebGUI.Forms.ToolStripStatusLabel
        Private mobjLayoutPanel As Gizmox.WebGUI.Forms.TableLayoutPanel
        Private mobjPictureBox As Gizmox.WebGUI.Forms.PictureBox
        Private mobjLogTextBox As Gizmox.WebGUI.Forms.TextBox
