...
Namespace OfflineModeSampleAppVB
    ...
    Public Class OfflineModeForm
        ...
        Private Sub OfflineModeForm_ClientPreload(ByVal objSender As Object, ByVal objArgs As Gizmox.WebGUI.Forms.Client.ClientEventArgs) Handles Me.ClientPreload
        ...
        ''' <param name="objSender">The source of the event.</param>
        ''' <param name="objArgs">The <see cref="Gizmox.WebGUI.Forms.Client.ClientEventArgs"/> instance containing the event data.</param>
        Private Sub OfflineModeForm_OfflineConfirming(ByVal objSender As Object, ByVal objArgs As Gizmox.WebGUI.Forms.Client.ClientEventArgs) Handles Me.OfflineConfirming
        ...
        ''' <param name="objSender">The source of the event.</param>
        ''' <param name="objArgs">The <see cref="Gizmox.WebGUI.Forms.Client.ClientEventArgs"/> instance containing the event data.</param>
        Private Sub OfflineModeForm_OfflineInitializing(ByVal objSender As Object, ByVal objArgs As Gizmox.WebGUI.Forms.Client.ClientEventArgs) Handles Me.OfflineInitializing
