...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="WC:Tags.ListBox[@Attr.CustomStyle='CustomAnchorListBoxSkin']|WC:Tags.ColorListBox[@Attr.CustomStyle='CustomAnchorListBoxSkin']" mode="modContent">
    <xsl:attribute name="onkeydown">
      mobjApp.CustomAnchorListBox_ChangeAnchor(event, <xsl:value-of select="@Attr.Id"/>);
    </xsl:attribute>
