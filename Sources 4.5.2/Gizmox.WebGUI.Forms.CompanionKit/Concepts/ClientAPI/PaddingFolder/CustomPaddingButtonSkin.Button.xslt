...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="WC:Tags.Button[@Attr.CustomStyle='CustomPaddingButtonSkin']" mode="modContent">
    <xsl:attribute name="onclick">
      mobjApp.CustomPaddingButton_ChangePadding(event, <xsl:value-of select="@Attr.Id"/>, true);
    </xsl:attribute>
    <xsl:attribute name="oncontextmenu">
      mobjApp.CustomPaddingButton_ChangePadding(event, <xsl:value-of select="@Attr.Id"/>, false);
    </xsl:attribute>
  ...
  <xsl:template match="WC:Tags.Button[@Attr.CustomStyle='CustomPaddingButtonSkin']" mode="modFrameCenterContent">
