...
namespace Gizmox.WebGUI.Forms.CompanionKit.Concepts.ClientAPI.FocusFolder
{
    ...
    /// A TextBox control
    /// </summary>
    [Skin(typeof(CustomFocusableTextBoxSkin))]
    [Serializable()]
    public class CustomFocusableTextBox : TextBox
    {
        public CustomFocusableTextBox()
        {
            this.CustomStyle = "CustomFocusableTextBoxSkin";
        }
    }
