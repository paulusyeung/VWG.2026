...
{
    public partial class MessageBoxDefaultButtonPage : UserControl
    {
        public MessageBoxDefaultButtonPage()
        {
            InitializeComponent();
        }
        ...
        private void MessageBoxDefaultButtonPage_Load(object sender, EventArgs e)
        {
            // Bind values of the MessageBoxDefaultButton enumerator to
            // ComboBox control
            mobjMessageBoxButtonsCB.DataSource = Enum.GetValues(typeof(MessageBoxDefaultButton));
        }
        ...
        private void mobjShowButton_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Message text", "Message", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question, (MessageBoxDefaultButton)mobjMessageBoxButtonsCB.SelectedValue, (MessageBoxOptions)mobjMessageBoxButtonsCB.SelectedValue, MessageBoxHandler, mobjShowModalMask.Checked);
        }
