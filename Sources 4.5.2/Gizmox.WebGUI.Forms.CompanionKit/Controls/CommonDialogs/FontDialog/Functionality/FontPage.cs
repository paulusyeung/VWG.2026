...
namespace CompanionKit.Controls.CommonDialogs.FontDialog.Functionality
{
    public partial class FontPage : UserControl
    {
        ...
        private void FontPage_Load(object sender, EventArgs e)
        {
            ...
            UpdateTestOfLabel(this.mobjChangeFontLabel.Font);
        }

        private void mobjChangeFontButton_Click(object sender, EventArgs e)
        {
            //Set initial Font for FontDialog
            this.mobjDemoFontDialog.Font = this.mobjChangeFontLabel.Font;
            //Show FontDialog
        ...
        {
            this.mobjChangeFontLabel.Text = string.Format("Font selected in the dialog: {0}, {1} pt.", newFont.Name, newFont.Size);
        }
        ...
        private void mobjDemoFontDialog_Closed(object sender, EventArgs e)
        {
            ...
            if (this.mobjDemoFontDialog.DialogResult == DialogResult.OK)
            {
                ...
                this.mobjChangeFontLabel.Font = this.mobjDemoFontDialog.Font;
                UpdateTestOfLabel(this.mobjChangeFontLabel.Font);
            }
        }
