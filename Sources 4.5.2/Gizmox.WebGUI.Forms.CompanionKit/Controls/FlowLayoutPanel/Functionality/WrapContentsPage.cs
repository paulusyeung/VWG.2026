...
{
    public partial class WrapContentsPage : UserControl
    {
        public WrapContentsPage()
        {
            InitializeComponent();
        }
        ...
        /// <summary>
        /// Handles the Load event of the WrapContentsPage control.
        /// </summary>
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">The <see cref="EventArgs"/> instance containing the event data.</param>
        private void WrapContentsPage_Load(object sender, EventArgs e)
        {
