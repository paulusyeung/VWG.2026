<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="StatelessPropertyWebFormVB.aspx.vb" Inherits=".StatelessPropertyWebFormVB" %>

<%@ Register Assembly="Gizmox.WebGUI.Forms, Version=2.0.5701.0, Culture=neutral, PublicKeyToken=c508b41386c60f1d"
    ...
    <form id="form1" runat="server">    
        ...
        <div style="margin-left:auto; margin-right:auto;">
            <table cellpadding="5" >
                <tr>
                    <td>
                        FormBox1: Stateless = <b><%=Me.FormBox1.Stateless%></b>
                        <br />
                    ...
                    <td>
                        FormBox2: Stateless = <b><%= Me.FormBox2.Stateless %></b>
                        <br />
