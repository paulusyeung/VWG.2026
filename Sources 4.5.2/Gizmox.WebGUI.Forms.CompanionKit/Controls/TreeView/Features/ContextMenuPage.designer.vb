Namespace CompanionKit.Controls.TreeView.Features
	...
	Partial Class ContextMenuPage
        ...
        Private Sub InitializeComponent()
            ...
            Me.mobjAddNodeMenuItem = New Gizmox.WebGUI.Forms.MenuItem()
            Me.mobjRemoveNadeMenuItem = New Gizmox.WebGUI.Forms.MenuItem()
            Me.mobjViewNodeMenuItem = New Gizmox.WebGUI.Forms.MenuItem()
            ...
            Me.mobjInfoLabel.Location = New System.Drawing.Point(46, 13)
            Me.mobjInfoLabel.Name = "mobjInfoLabel"
            Me.mobjInfoLabel.Size = New System.Drawing.Size(371, 50)
            Me.mobjInfoLabel.TabIndex = 0
            Me.mobjInfoLabel.Text = "TreeView with ContextMenu"
            Me.mobjInfoLabel.TextAlign = System.Drawing.ContentAlignment.MiddleLeft
            ' 
            ' mobjTreeView
            ' 
            Me.mobjTreeView.ContextMenu = Me.mobjContextMenu
            Me.mobjTreeView.Dock = Gizmox.WebGUI.Forms.DockStyle.Fill
            Me.mobjTreeView.Location = New System.Drawing.Point(46, 73)
            ...
            Me.mobjTreeView.Size = New System.Drawing.Size(371, 82)
            Me.mobjTreeView.TabIndex = 1
            ' 
            ' mobjContextMenu
            ' 
            Me.mobjContextMenu.MenuItems.AddRange(New Gizmox.WebGUI.Forms.MenuItem() {Me.mobjAddNodeMenuItem, Me.mobjRemoveNadeMenuItem, Me.mobjViewNodeMenuItem})
            ' 
            ' mobjAddNodeMenuItem
            ' 
            Me.mobjAddNodeMenuItem.Index = 0
            Me.mobjAddNodeMenuItem.Text = "Add new node"
            ' 
            ' mobjRemoveNadeMenuItem
            ' 
            Me.mobjRemoveNadeMenuItem.Index = 1
            Me.mobjRemoveNadeMenuItem.Text = "Remove selected node"
            ' 
            ' mobjViewNodeMenuItem
            ' 
            Me.mobjViewNodeMenuItem.Index = 2
            Me.mobjViewNodeMenuItem.Text = "View selected node"
            ' 
            ' mobjTreeNode1
            ' 
            Me.mobjTreeNode1.ContextMenu = Me.mobjContextMenu
            ...
            ' mobjTreeNode4
            ' 
            Me.mobjTreeNode4.ContextMenu = Me.mobjContextMenu
            Me.mobjTreeNode4.Name = "treeNode4"
            Me.mobjTreeNode4.Text = "Tree Node4"
            ' 
            ' mobjTreeNode2
            ' 
            Me.mobjTreeNode2.ContextMenu = Me.mobjContextMenu
            ...
            ' mobjTreeNode5
            ' 
            Me.mobjTreeNode5.ContextMenu = Me.mobjContextMenu
            Me.mobjTreeNode5.Name = "treeNode5"
            Me.mobjTreeNode5.Text = "Tree Node5"
            ' 
            ' mobjTreeNode6
            ' 
            Me.mobjTreeNode6.ContextMenu = Me.mobjContextMenu
            Me.mobjTreeNode6.Name = "treeNode6"
            Me.mobjTreeNode6.Text = "Tree Node6"
            ' 
            ' mobjTreeNode3
            ' 
            Me.mobjTreeNode3.ContextMenu = Me.mobjContextMenu
            Me.mobjTreeNode3.Name = "treeNode3"
            Me.mobjTreeNode3.Nodes.AddRange(New Gizmox.WebGUI.Forms.TreeNode() {Me.mobjTreeNode7, Me.mobjTreeNode8})
            Me.mobjTreeNode3.Text = "Tree Node3"
            ' 
            ' mobjTreeNode7
            ' 
            Me.mobjTreeNode7.ContextMenu = Me.mobjContextMenu
            Me.mobjTreeNode7.Name = "treeNode7"
            Me.mobjTreeNode7.Text = "Tree Node7"
            ' 
            ' mobjTreeNode8
            ' 
            Me.mobjTreeNode8.ContextMenu = Me.mobjContextMenu
            ...
            Me.mobjLayoutPanel.Size = New System.Drawing.Size(464, 197)
        ...
        Private mobjTreeView As Global.Gizmox.WebGUI.Forms.TreeView
        ...
        Private WithEvents mobjAddNodeMenuItem As MenuItem
        Private WithEvents mobjRemoveNadeMenuItem As MenuItem
        Private WithEvents mobjViewNodeMenuItem As MenuItem
