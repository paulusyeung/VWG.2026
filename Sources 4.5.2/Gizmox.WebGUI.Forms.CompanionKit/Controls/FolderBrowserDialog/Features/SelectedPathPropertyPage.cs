...
{
    public partial class SelectedPathPropertyPage : UserControl
    {
        public SelectedPathPropertyPage()
        {
            InitializeComponent();
        }
        ...
        {
            // Set manually entered path to FolderBrowserDialog property
            mobjFolderBrowserDialog.SelectedPath = mobjPathTextBox.Text;
