Namespace CompanionKit.Controls.ListView.Features
	...
	Partial Class GroupingPage
        ...
        Private Sub InitializeComponent()
            Dim ListViewGroup1 As Gizmox.WebGUI.Forms.ListViewGroup = New Gizmox.WebGUI.Forms.ListViewGroup("Employer", Gizmox.WebGUI.Forms.HorizontalAlignment.Left)
            Dim ListViewGroup2 As Gizmox.WebGUI.Forms.ListViewGroup = New Gizmox.WebGUI.Forms.ListViewGroup("Employees", Gizmox.WebGUI.Forms.HorizontalAlignment.Left)
            ...
            Me.columnEmail = CType(New Gizmox.WebGUI.Forms.ColumnHeader(), Gizmox.WebGUI.Forms.ColumnHeader)
            ...
            'mobjListView
            '
            Me.mobjListView.Columns.AddRange(New Gizmox.WebGUI.Forms.ColumnHeader() {Me.columnUserID, Me.columnUserName, Me.columnPhone, Me.columnEmail})
            Me.mobjListView.DataMember = Nothing
            Me.mobjListView.Dock = Gizmox.WebGUI.Forms.DockStyle.Fill
            ListViewGroup1.Header = "Employer"
            ListViewGroup1.HeaderAlignment = Gizmox.WebGUI.Forms.HorizontalAlignment.Left
            ListViewGroup1.Name = "employer"
            ListViewGroup2.Header = "Employees"
            ListViewGroup2.HeaderAlignment = Gizmox.WebGUI.Forms.HorizontalAlignment.Left
            ListViewGroup2.Name = "employees"
            Me.mobjListView.Groups.AddRange(New Gizmox.WebGUI.Forms.ListViewGroup() {ListViewGroup1, ListViewGroup2})
            Me.mobjListView.Location = New System.Drawing.Point(0, 60)
            Me.mobjListView.Name = "mobjListView"
            Me.mobjListView.Size = New System.Drawing.Size(320, 340)
            ...
            Me.columnUserID.Width = 50
            '
            'columnUserName
            '
            Me.columnUserName.Text = "User Name"
            Me.columnUserName.Width = 70
            '
            'columnPhone
            '
            Me.columnPhone.Text = "Phone"
            Me.columnPhone.Width = 110
            '
            'columnEmail
            '
            Me.columnEmail.Text = "Email"
            Me.columnEmail.Width = 100
            '
            'mobjInfoLabel
            '
            ...
            Me.mobjInfoLabel.Text = "ListView with groupped items:"
