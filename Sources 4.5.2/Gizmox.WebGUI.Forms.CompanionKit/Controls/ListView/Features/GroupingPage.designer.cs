...
namespace CompanionKit.Controls.ListView.Features
{
    partial class GroupingPage
    {
        ...
        {
            Gizmox.WebGUI.Forms.ListViewGroup listViewGroup1 = new Gizmox.WebGUI.Forms.ListViewGroup("Employer", Gizmox.WebGUI.Forms.HorizontalAlignment.Left);
            Gizmox.WebGUI.Forms.ListViewGroup listViewGroup2 = new Gizmox.WebGUI.Forms.ListViewGroup("Employees", Gizmox.WebGUI.Forms.HorizontalAlignment.Left);
            ...
            this.columnEmail = ((Gizmox.WebGUI.Forms.ColumnHeader)(new Gizmox.WebGUI.Forms.ColumnHeader()));
            ...
            this.mobjListView.Groups.AddRange(new Gizmox.WebGUI.Forms.ListViewGroup[] {
            listViewGroup1,
            listViewGroup2});
            this.mobjListView.Location = new System.Drawing.Point(0, 60);
            this.mobjListView.Name = "mobjListView";
            this.mobjListView.Size = new System.Drawing.Size(320, 340);
            ...
            this.mobjInfoLabel.Text = "ListView with groupped items:";
