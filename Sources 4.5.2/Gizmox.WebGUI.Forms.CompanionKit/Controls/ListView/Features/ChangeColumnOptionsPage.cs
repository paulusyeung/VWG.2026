...
{
    public partial class ChangeColumnOptionsPage : UserControl
    {
        private RandomData mobjRandomData = null;

        public ChangeColumnOptionsPage()
        {
        ...
        {
            Gizmox.WebGUI.Forms.Dialogs.ListViewColumnOptions objListViewColumnOptions = new Gizmox.WebGUI.Forms.Dialogs.ListViewColumnOptions(this.mobjListView);
