...
<xsl:stylesheet version="1.0"
	...
	xmlns:WC="wgcontrols">
  <!-- Details Mode -->
  <xsl:template match="WC:Tags.ListView[@Attr.View='Details' and @Attr.CustomStyle='MainDeviceListViewSkin']" mode="modContent">
  ...
  <!-- List Mode -->
  <xsl:template match="WC:Tags.ListView[@Attr.View='List' and @Attr.CustomStyle='MainDeviceListViewSkin']" mode="modContent">
    <xsl:param name="prmIsEnabled" />
  ...
  <!-- Small icons Mode -->
  <xsl:template match="WC:Tags.ListView[@Attr.View='SmallIcon' and @Attr.CustomStyle='MainDeviceListViewSkin']" mode="modContent">
    <xsl:param name="prmIsEnabled" />
  ...
  <!-- Large icons Mode -->
  <xsl:template match="WC:Tags.ListView[@Attr.View='LargeIcon' and @Attr.CustomStyle='MainDeviceListViewSkin']" mode="modContent">
    <xsl:param name="prmIsEnabled" />
  ...
  <xsl:template match="WC:Tags.ListView[@Attr.View='Details' and @Attr.CustomStyle='MainDeviceListViewSkin']" mode="modListViewDetailedColumns">
  ...
  <xsl:template match="WC:Tags.ListView[@Attr.View='Details' and @Attr.CustomStyle='MainDeviceListViewSkin']" mode="modListViewDetailedHeader">
  ...
  <xsl:template match="Tags.Group[../@Attr.CustomStyle='MainDeviceListViewSkin']" mode="modListViewGroupHeader">
  ...
  <xsl:template match="Tags.Row[../@Attr.CustomStyle='MainDeviceListViewSkin']" mode="modListViewDetailedItemRow">
