...
namespace Manoli.Utils.CSharpFormat
{
	...
	public abstract class SourceFormat
	{
        ...
        private List<int> _highlightedLines;

        /// <summary>
        /// Gets or sets the highlighted lines.
        /// </summary>
        /// <value>
        /// The highlighted lines.
        /// </value>
        public List<int> HighlightedLines
        {
            get { return _highlightedLines; }
            set { _highlightedLines = value; }
        }
		...
		public string FormatCode(Stream source)
		{
			...
			reader.Close();
			return FormatCode(s, _lineNumbers, _alternate, _embedStyleSheet, false, _highlightedLines);
		}
		...
		{
            return FormatCode(source, _lineNumbers, _alternate, _embedStyleSheet, false, _highlightedLines);
		}
		...
		{
            return FormatCode(source, false, false, false, true, _highlightedLines);
		}
		...
		public static Stream GetCssStream()
		{
			return Assembly.GetExecutingAssembly().GetManifestResourceStream(
				"Gizmox.WebGUI.Forms.CompanionKit.Engine.Code.csharp.css");
		}
		...
		private string FormatCode(string source, bool lineNumbers,
            bool alternate, bool embedStyleSheet, bool subCode, List<int> arrHighLightedLines)
		{
			...
			if (lineNumbers || alternate) //we have to process the code line by line
			{
                ...
                while ((line = reader.ReadLine()) != null)
                {
                    ...
                    if (arrHighLightedLines != null && arrHighLightedLines.Contains(i))
                    {
                        className += " highlight";
                        arrHighLightedLines.Remove(i);
                    }

                    sb.Append(string.Format("<pre{0}>", string.IsNullOrEmpty(className) ? "" : string.Format(" class='{0}'", className)));
