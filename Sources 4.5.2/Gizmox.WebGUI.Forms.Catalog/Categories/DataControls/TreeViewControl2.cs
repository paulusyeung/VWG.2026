...
namespace Gizmox.WebGUI.Forms.Catalog.Categories.DataControls
{
    ...
    [Serializable()]
    public class TreeViewControl2 : UserControl, IHostedApplication
	{
		...
		private void AddNode(TreeNodeCollection objNodes,int intCount)
		{
            ...
            if (mintIndex % 2 == 0)
            {
                objTreeNode.StateImageIndex = 1;    
            }
            else if (mintIndex % 3 == 0)
            {
                //Set an empty value in the StateImageIndex(-1)
            }
            else
            {
                objTreeNode.StateImageIndex = 0;
            }
		...
		private void InitializeComponent()
		{
            ...
            // stateImageList
            // 
            stateImageList.Images.Add("Cut", new IconResourceHandle("Cut.gif"));
            stateImageList.Images.Add("Paste", new IconResourceHandle("Paste.gif"));
            stateImageList.Images.Add("Open", new IconResourceHandle("Open.gif"));
            stateImageList.ImageSize = new System.Drawing.Size(16, 16);
            stateImageList.Images.SetKeyName(0, "Cut.gif");
            stateImageList.Images.SetKeyName(1, "Paste.gif");
            stateImageList.Images.SetKeyName(2, "Open.gif");
			// 
			// treeView1
			// 
