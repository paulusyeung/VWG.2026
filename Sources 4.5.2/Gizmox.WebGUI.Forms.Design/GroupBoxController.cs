...
namespace Gizmox.WebGUI.Forms.Design
{
	...
	public class GroupBoxController : Gizmox.WebGUI.Client.Controllers.GroupBoxController
	{
		#region C'Tor/D'Tor
		...
		/// <param name="objWebObject"></param>
		public GroupBoxController(IContext objContext, object objWebObject): base(objContext, objWebObject)
		{
		}
