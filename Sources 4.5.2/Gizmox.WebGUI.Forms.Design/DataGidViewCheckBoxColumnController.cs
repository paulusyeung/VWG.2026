...
{
    #region DataGidViewCheckBoxColumnController Class

    /// <summary>
    /// Controls the relations between a webgui control and a winforms control
    /// </summary>
    
	public class DataGidViewCheckBoxColumnController : Gizmox.WebGUI.Client.Controllers.DataGidViewCheckBoxColumnController
    {
        #region C'Tor/D'Tor
    ...
    #endregion DataGidViewCheckBoxColumnController Class
