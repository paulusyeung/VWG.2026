...
{
    class TranslateDepthUnitsEditor : UITypeEditor
    {
                ...
                context.Instance != null)
            {
                if (provider != null)
                {
                    ...
                    if (mobjEditorService != null)
                    {
                        ...
                        objListBox.Items.Add(LengthUnits.Pixel);
                        objListBox.Items.Add(LengthUnits.em);
                        objListBox.Items.Add(LengthUnits.Point);
                    
                        // Set the selected item.
                        objListBox.SelectedItem = (LengthUnits)value;
