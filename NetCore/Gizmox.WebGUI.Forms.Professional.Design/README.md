# Gizmox.WebGUI.Forms.Professional.Design (.NET 8 Standalone Migration)

## Purpose

This project is the standalone .NET 8 migration target for the legacy `Gizmox.WebGUI.Forms.Professional.Design` assembly.
...
- Main project file: `Gizmox.WebGUI.Forms.Professional.Design.csproj`
...
Run the focused design-time validation for `GoogleMap` and `StackPanel` from workspace root:
