...
{
[Serializable]
	internal class ServerExplorerNode : Gizmox.WebGUI.Forms.TreeNode
	{
		/// 
		/// Gets the explorer.
		/// </summary>
		...
		/// The explorer.
		/// </value>
		protected ServerExplorer Explorer => Form as ServerExplorer;

		internal ListView List
		{
			get
			{
				if (base.TreeView is ServerExplorerTree)
				{
					return ((ServerExplorerTree)base.TreeView).List;
				}
				return null;
			}
		}
		...
		public ServerExplorerNode()
		{
			...
			base.HasNodes = true;
			base.BeforeExpand += TraceTreeNode_BeforeExpand;
			base.BeforeSelect += TraceTreeNode_BeforeSelect;
		}
		...
		private void TraceTreeNode_BeforeExpand(object objSource, TreeViewCancelEventArgs objArgs)
		{
			if (!base.Loaded)
			{
				...
				base.HasNodes = base.Nodes.Count > 0;
			}
		}
