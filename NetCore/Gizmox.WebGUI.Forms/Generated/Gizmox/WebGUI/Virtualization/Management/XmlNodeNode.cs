...
/// 
	...
	internal class XmlNodeNode : ServerExplorerNode
	{
		...
		{
			mobjNode = objNode;
			base.Label = objNode.Name;
			base.HasNodes = objNode.ChildNodes.Count > 0;
		...
		{
			foreach (XmlNode childNode in mobjNode.ChildNodes)
			{
				if (childNode.NodeType == XmlNodeType.Element)
				{
					base.Nodes.Add(new XmlNodeNode(childNode));
				}
			}
		}
		...
		{
			foreach (XmlAttribute attribute in mobjNode.Attributes)
			{
