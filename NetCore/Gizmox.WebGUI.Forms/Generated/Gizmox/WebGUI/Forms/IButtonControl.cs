...
/// 
	...
	public interface IButtonControl
	{
		...
		/// 
		/// Notifies a control that it is the default button so that its appearance and behavior is adjusted accordingly.</para>
		/// </summary>
		/// <param name="value">
		...
		/// 
		/// Generates a <see cref="E:System.Windows.Forms.Control.Click" /> event for the control.</para>
		/// </summary>
		void PerformClick();
	}
}
