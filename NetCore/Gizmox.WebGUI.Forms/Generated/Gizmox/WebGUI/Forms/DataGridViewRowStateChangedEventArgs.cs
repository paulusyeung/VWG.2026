...
/// Provides data for the <see cref="E:Gizmox.WebGUI.Forms.DataGridView.RowStateChanged"></see> event of a <see cref="T:Gizmox.WebGUI.Forms.DataGridView"></see>.</summary>
	...
	public class DataGridViewRowStateChangedEventArgs : EventArgs
	{
		...
		/// Gets the <see cref="T:Gizmox.WebGUI.Forms.DataGridViewRow"></see> that has a changed state.</summary>
		/// The <see cref="T:Gizmox.WebGUI.Forms.DataGridViewRow"></see> that has a changed state.</returns>
		/// 1</filterpriority>
		public DataGridViewRow Row => mobjDataGridViewRow;

		/// Gets the state that has changed on the row.</summary>
		/// One of the <see cref="T:Gizmox.WebGUI.Forms.DataGridViewElementStates"></see> values indicating the state that has changed on the row.</returns>
		public DataGridViewElementStates StateChanged => menmElementStateChanged;

		/// Initializes a new instance of the <see cref="T:Gizmox.WebGUI.Forms.DataGridViewRowStateChangedEventArgs"></see> class. </summary>
		...
		{
			mobjDataGridViewRow = objDataGridViewRow;
