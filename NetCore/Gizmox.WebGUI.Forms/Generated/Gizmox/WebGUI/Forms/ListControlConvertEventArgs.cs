...
{
	/// Provides data for the <see cref="E:Gizmox.WebGUI.Forms.ListControl.Format"></see> event. </summary>
	/// 2</filterpriority>    
	[Serializable]
	public class ListControlConvertEventArgs : ConvertEventArgs
	{
		...
		/// Gets a data source item.</summary>
		/// The <see cref="T:System.Object"></see> that represents an item in the data source.</returns>
		/// 1</filterpriority>
		public object ListItem => mobjListItem;

		/// Initializes a new instance of the <see cref="T:Gizmox.WebGUI.Forms.ListControlConvertEventArgs"></see> class with the specified object, type, and list item.</summary>
