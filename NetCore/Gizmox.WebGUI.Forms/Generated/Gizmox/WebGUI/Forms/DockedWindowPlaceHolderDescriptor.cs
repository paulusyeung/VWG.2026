...
namespace Gizmox.WebGUI.Forms
{
	...
	internal class DockedWindowPlaceHolderDescriptor : DockedObjectDescriptor
	{
		...
		/// </value>
		public DockingWindowName WindowName => mobjWindowDescriptor.WindowName;
		...
		{
			SetContainer(objWindowDescriptor.ParentDescriptor);
			mobjZoneType = objZoneType;
			mobjWindowDescriptor = objWindowDescriptor;
		}
