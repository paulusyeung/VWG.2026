...
/// 
	...
	/// </summary>
	[Serializable]
	[Skin(typeof(ZoneHeaderPanelSkin))]
	[ToolboxItem(false)]
	public class ZoneHeaderPanel : Panel
	{
		...
		public override ContextMenuStrip ContextMenuStrip
		{
			get
			{
				if (!base.DesignMode)
				{
					return mobjOwningZone.Manager.GetDockedContextMenuStrip(mobjOwningZone);
				}
		...
		{
			mobjOwningZone = objOwningZone;
			CustomStyle = "ZoneHeaderPanelSkin";
		}
	}
}
