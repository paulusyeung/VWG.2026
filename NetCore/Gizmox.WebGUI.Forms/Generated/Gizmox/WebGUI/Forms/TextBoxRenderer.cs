...
namespace Gizmox.WebGUI.Forms
{
	...
	public class TextBoxRenderer : ControlRenderer
	{
		...
		{
			if (base.Control is TextBox textBox)
			{
				ControlRenderer.RenderText(objContext, objGraphics, textBox.Text, textBox.Font, textBox.ForeColor, textBox.Size, textBox.TextAlign, blnWrapText: true);
			}
		}
	}
}
