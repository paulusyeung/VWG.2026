...
/// 
	...
	{
		/// Gets the drag-and-drop operation feedback that is displayed.</summary> 
		...
		/// Gets or sets whether drag operation should use the default cursors that are associated with drag-drop effects.</summary> 
		/// true if the default pointers are used; otherwise, false.</returns> 
		/// 1</filterpriority>
		[Obsolete("Not implemented. Added for migration compatibility")]
		[Browsable(false)]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		...
		/// Initializes a new instance of the <see cref="T:Gizmox.WebGUI.Forms.GiveFeedbackEventArgs"></see> class.</summary> 
