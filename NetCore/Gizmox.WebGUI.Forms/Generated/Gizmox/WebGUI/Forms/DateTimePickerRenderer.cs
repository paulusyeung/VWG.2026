...
namespace Gizmox.WebGUI.Forms
{
	...
	public class DateTimePickerRenderer : ControlRenderer
	{
		...
		{
			if (base.Control is DateTimePicker dateTimePicker)
			{
				ControlRenderer.RenderText(objContext, objGraphics, dateTimePicker.Text, dateTimePicker.Font, dateTimePicker.ForeColor, dateTimePicker.Size, HorizontalAlignment.Left, blnWrapText: true);
			}
		}
	}
}
