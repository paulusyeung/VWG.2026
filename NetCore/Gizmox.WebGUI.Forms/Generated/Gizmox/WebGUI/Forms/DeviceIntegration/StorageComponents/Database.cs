...
namespace Gizmox.WebGUI.Forms.DeviceIntegration.StorageComponents
{
	...
	public class Database : IDatabase, IDatabaseOptions
	{
		...
		/// Gets the storage.
		/// </summary>
		public Storage Storage => mobjStorage;
		...
		public ISQLTransaction Transaction(EventHandler<TransactionEventArgs> objCallback)
		{
			...
			string value = mobjStorage.TransactionCallbackMethods.StoreContextualSingleCallMethod(this, "transaction", objCallback);
			ArrayList arrayList = new ArrayList();
			arrayList.Add(value);
			arrayList.Add(DatabaseOptions.GetClientArgument(this));
			arrayList.Add(sQLTransaction.ID);
			mobjStorage.Invoke("DeviceIntegrator.Storage.transaction", arrayList.ToArray());
