...
/// 
	...
	public class SQLTransaction : ISQLTransaction
	{
		...
		public void ExecuteSQL(EventHandler<SQLResultEventArgs> objMethod, string strSQLCommand)
		{
			...
			arrayList.Add(value);
			arrayList.Add(strSQLCommand);
			arrayList.Add(mstrId);
			mobjDatabase.Storage.Invoke("DeviceIntegrator.Storage.executeSQLByTransaction", arrayList.ToArray());
		}
	}
}
