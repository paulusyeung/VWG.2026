...
/// 
	...
	public class MediaFile : IMediaFile
	{
		...
		public DateTime LastModifiedDate
		{
			get
			{
				return mobjLastModifiedDate;
			}
			internal set
			{
				mobjLastModifiedDate = value;
			}
		}
		...
		{
			if (!string.IsNullOrEmpty(objEvent["count"]) && int.TryParse(objEvent["count"], out var result))
			{
				IMediaFile[] array = new IMediaFile[result];
