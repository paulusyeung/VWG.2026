...
[Serializable]
	public class EntryMetadata : DevicePropertyDictionary, IMetadata
	{
		...
		internal static EntryMetadata CreateFromVWGEvent(IEvent objEvent)
		{
			EntryMetadata entryMetadata = new EntryMetadata();
			entryMetadata.ModificationTime = DateTime.ParseExact(objEvent["modificationTime"].Substring(0, 24), "ddd MMM d yyyy HH:mm:ss", CultureInfo.InvariantCulture);
