...
/// 
	...
	public class PhonegapFileDownloadEventArgs : FileDownloadEventArgs
	{
		...
		/// Gets the error.
		/// </summary>
		public override IFileTransferError Error => mobjFileTransferError;

		/// 
		/// Gets the file entry.
		/// </summary>
		public override IFileEntry FileEntry => mobjFileEntry;
		...
		public static FileDownloadEventArgs FromVWGEvent(IEvent objEvent, FileManager objManager)
		{
			...
			else
			{
				...
				objEventArgs.mobjFileEntry = Gizmox.WebGUI.Forms.DeviceIntegration.FileManagement.FileEntry.FromVWGEvent(objEvent, objManager, null);
			}
			return objEventArgs;
		}
	}
