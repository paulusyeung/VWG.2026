...
namespace Gizmox.WebGUI.Forms.DeviceIntegration.FileManagement
{
	...
	public class FileTransfer : IFileTransfer
	{
		...
		internal IDictionary<string, object> GetProgressEventData()
		{
			...
			if (mobjProgressClientCallback.Key != null)
			{
				dictionary.Add("client", mobjProgressClientCallback.Key);
				if (mobjProgressClientCallback.Value != null)
				{
					dictionary.Add("clientp", mobjProgressClientCallback.Value);
				}
			}
