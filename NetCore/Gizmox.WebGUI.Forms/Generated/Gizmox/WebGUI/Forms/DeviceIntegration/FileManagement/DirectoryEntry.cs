...
namespace Gizmox.WebGUI.Forms.DeviceIntegration.FileManagement
{
	...
	public class DirectoryEntry : Entry, IDirectoryEntry, IEntry
	{
		...
		internal static DirectoryEntry FromVWGEvent(string strPrefix, IEvent objEvent, FileManager objFileManager, IFileSystem objFileSystem)
		{
			...
			{
				DirectoryEntry directoryEntry = new DirectoryEntry(objFileManager, objFileSystem);
				Entry.FillFromEvent(strPrefix, directoryEntry, objEvent);
		...
		{
			return new DirectoryReader(this, base.FileManager);
		}
	}
}
