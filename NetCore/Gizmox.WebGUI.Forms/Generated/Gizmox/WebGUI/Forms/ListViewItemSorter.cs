...
/// 
	...
	public class ListViewItemSorter : IComparer
	{
		...
		public int Compare(object objObjectA, object objObjectB)
		{
			...
			ICollection sortingColumns = mobjListView.SortingColumns;
			if (listViewItem != null && listViewItem2 != null)
			{
				...
				{
					int num = ((item.SortOrder == SortOrder.Ascending) ? 1 : (-1));
					int num2 = 0;
					num2 = listViewItem.SubItems[item.Index].Text.CompareTo(listViewItem2.SubItems[item.Index].Text);
					if (num2 != 0)
					{
						return num2 * num;
					}
