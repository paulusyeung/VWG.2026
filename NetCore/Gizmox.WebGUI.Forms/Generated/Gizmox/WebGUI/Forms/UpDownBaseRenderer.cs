...
/// 
	...
	{
		/// 
		/// Initializes a new instance of the <see cref="T:Gizmox.WebGUI.Forms.UpDownBaseRenderer" /> class.
		/// </summary>
		...
		{
			if (base.Control is UpDownBase upDownBase)
			{
				ControlRenderer.RenderText(objContext, objGraphics, upDownBase.Text, upDownBase.Font, upDownBase.ForeColor, upDownBase.Size, HorizontalAlignment.Left, blnWrapText: true);
			}
		}
	}
}
