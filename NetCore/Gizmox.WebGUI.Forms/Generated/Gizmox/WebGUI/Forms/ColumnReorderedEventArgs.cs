...
/// 
	...
	public class ColumnReorderedEventArgs : CancelEventArgs
	{
		...
		/// </summary>
		/// The header.</value>
		public ColumnHeader Header => mobjHeader;

		/// 
		/// Gets the new index of the display.
		/// </summary>
		/// The new index of the display.</value>
		public int NewDisplayIndex => mintNewDisplayIndex;

		/// 
		/// Gets the old index of the display.
		/// </summary>
		/// The old index of the display.</value>
		public int OldDisplayIndex => mintOldDisplayIndex;
