...
namespace Gizmox.WebGUI.Forms.ContextualToolbar
{
	...
	internal class ProxyControlContextualToolbar : ContextualToolbar
	{
		...
		protected override void InitContextualToolbarButtons()
		{
			...
			if (base.Skin is ProxyControlContextualToolbarSkin proxyControlContextualToolbarSkin)
			{
				AddChild(new ContextualToolbarButton("Actions", proxyControlContextualToolbarSkin.ContextualToolbarActions, "Add/Remove actions."));
				AddChild(new ContextualToolbarButton("VisualTemplate", proxyControlContextualToolbarSkin.ContextualToolbarVisualTemplates, "Add/Remove visual templates."));
			}
		}
	}
}
