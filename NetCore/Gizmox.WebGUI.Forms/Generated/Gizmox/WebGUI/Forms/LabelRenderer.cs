...
namespace Gizmox.WebGUI.Forms
{
	...
	public class LabelRenderer : ControlRenderer
	{
		...
		{
			if (base.Control is Label label)
			{
				ControlRenderer.RenderText(objContext, objGraphics, label.Text, label.Font, label.ForeColor, label.Size, label.TextAlign, blnWrapText: true);
			}
		}
	}
}
