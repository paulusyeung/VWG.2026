...
namespace Gizmox.WebGUI.Forms
{
	...
	public class DataGridViewRowContextMenuNeededEventArgs : EventArgs
	{
		...
		/// Gets or sets the shortcut menu for the row that raised the <see cref="E:System.Windows.Forms.DataGridView.RowContextMenuStripNeeded"></see> event.</summary>
		/// The <see cref="T:System.Windows.Forms.ContextMenuStrip"></see> in use.</returns>
