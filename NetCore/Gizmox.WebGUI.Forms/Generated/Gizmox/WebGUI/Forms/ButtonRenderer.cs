...
namespace Gizmox.WebGUI.Forms
{
	...
	public class ButtonRenderer : ButtonBaseRenderer
	{
		...
		{
			if (base.Control is Button { Skin: ButtonSkin skin } button)
			{
				if (button.Enabled)
				{
					ControlRenderer.RenderFrame(objContext, objGraphics, skin, skin.NormalStyle, ControlRenderer.GetContentRegion(button, blnApplyPadding: false, blnApplyBorder: false));
				}
				else
				{
					ControlRenderer.RenderFrame(objContext, objGraphics, skin, skin.DisabledStyle, ControlRenderer.GetContentRegion(button, blnApplyPadding: false, blnApplyBorder: false));
				}
			}
		}
	}
