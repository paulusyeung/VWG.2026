...
namespace Gizmox.WebGUI.Forms
{
	...
	public class DataGridViewCellMouseEventArgs : MouseEventArgs
	{
		...
		/// Gets the zero-based column index of the cell.</summary>
		/// An integer specifying the column index.</returns>
		/// 1</filterpriority>
		public int ColumnIndex => mintColumnIndex;

		/// Gets the zero-based row index of the cell.</summary>
		/// An integer specifying the row index.</returns>
		/// 1</filterpriority>
		public int RowIndex => mintRowIndex;

		/// Initializes a new instance of the <see cref="T:Gizmox.WebGUI.Forms.DataGridViewCellMouseEventArgs"></see> class.</summary>
