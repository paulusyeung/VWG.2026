...
namespace Gizmox.WebGUI.Forms
{
	...
	public class UpDownEventArgs : EventArgs
	{
		...
		/// Gets a value that represents which button the user clicked.</summary>
		/// A value that represents which button the user clicked.</returns>
		/// 1</filterpriority>
		public int ButtonID => mintButtonID;

		/// Initializes a new instance of the <see cref="T:Gizmox.WebGUI.Forms.UpDownEventArgs"></see> class</summary>
