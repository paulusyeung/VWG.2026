...
namespace Gizmox.WebGUI.Forms
{
	...
	public class EditValueEditingEventArgs : CancelEventArgs
	{
		...
		/// </summary>
		/// 
		///   true</c> if [exit edit mode]; otherwise, false</c>.
		/// </value>
		public bool ExitEditMode
		{
			get
			{
				return mblnExitEditMode;
			}
			set
			{
				mblnExitEditMode = value;
			}
		}
		...
		public object FormattedValue
		{
			get
			{
				return mobjFormattedValue;
			}
			set
			{
				mobjFormattedValue = value;
			}
		}
		...
		{
			mobjParameters = objParameters;
			mblnExitEditMode = true;
			mobjFormattedValue = objParameters["value"];
		}
	}
}
