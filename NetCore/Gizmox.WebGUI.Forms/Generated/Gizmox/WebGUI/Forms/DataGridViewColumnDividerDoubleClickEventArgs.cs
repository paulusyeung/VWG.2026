...
{
/// Provides data for the <see cref="E:Gizmox.WebGUI.Forms.DataGridView.ColumnDividerDoubleClick"></see> event of a <see cref="T:Gizmox.WebGUI.Forms.DataGridView"></see>. </summary>
	[Serializable]
	public class DataGridViewColumnDividerDoubleClickEventArgs : HandledMouseEventArgs
	{
		private int mintColumnIndex;

		/// The index of the column next to the column divider that was double-clicked.</summary>
		/// The index of the column next to the divider. </returns>
		public int ColumnIndex => mintColumnIndex;

		/// Initializes a new instance of the <see cref="T:Gizmox.WebGUI.Forms.DataGridViewColumnDividerDoubleClickEventArgs"></see> class. </summary>
