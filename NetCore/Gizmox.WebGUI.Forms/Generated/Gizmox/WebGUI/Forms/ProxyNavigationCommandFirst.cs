...
/// 
	...
	/// </summary>
	[Serializable]
	[WebCollectionEditorItemTypeName("Navigate First")]
	public class ProxyNavigationCommandFirst : ProxyNavigationCommand
	{
		/// 
		/// Initializes a new instance of the <see cref="T:Gizmox.WebGUI.Forms.ProxyNavigationCommandFirst" /> class.
		/// </summary>
		...
		{
			return objINavigationControl?.MoveFirst() ?? false;
		}
