...
/// 
	...
	public class ProxyCloseActiveFormCommand : ProxyAction
	{
		...
		/// 
		/// Initializes a new instance of the <see cref="T:Gizmox.WebGUI.Forms.ProxyCloseActiveFormCommand" /> class.
		/// </summary>
		...
		public override void Execute()
		{
			...
			if (context != null && context.ActiveForm is Form { CloseBox: not false, FormBorderStyle: not FormBorderStyle.None })
			{
