...
namespace Gizmox.WebGUI.Forms
{
	...
	public class ControlWinFormsCompatibility : WinFormsCompatibility
	{
		...
		/// </summary>
		/// 
		/// True</c> if control resizing should raise Resize events for contained controls like in WinForms; otherwise, False</c>; Default</c> if a value should be inherited from Config settings.
		/// </value>
		...
		public WinFormsCompatibilityStates RecursiveResizeEvent
		{
			get
			{
				return GetFeature("RecursiveResizeEvent");
			}
			set
			{
				SetFeature("RecursiveResizeEvent", value);
			}
		}
		...
		/// </summary>
		/// 
		/// true</c> if control resizing should raise Resize events for contained controls like in WinForms; otherwise, false</c>.
		/// </value>
		[Browsable(false)]
		public bool IsRecursiveResizeEvent => GetFeatureBoolValue("RecursiveResizeEvent");
		...
		public WinFormsCompatibilityStates ForbidDockMargin
		{
			get
			{
				return GetFeature("ForbidDockMargin");
			}
			set
			{
				SetFeature("ForbidDockMargin", value);
			}
		}
		...
		/// </summary>
		[Browsable(false)]
		public bool IsForbidDockMargin => GetFeatureBoolValue("ForbidDockMargin");
	}
}
