...
{
	/// Represents a collection of cells that are selected in a <see cref="T:Gizmox.WebGUI.Forms.DataGridView"></see>.</summary>
	/// 2</filterpriority>
	[Serializable]
	[ListBindable(false)]
	public class DataGridViewSelectedCellCollection : BaseCollection, IList, ICollection, IEnumerable
	{
		...
		/// Gets the cell at the specified index.</summary>
		/// The <see cref="T:Gizmox.WebGUI.Forms.DataGridViewCell"></see> at the specified index.</returns>
		...
		/// 1</filterpriority>
		public DataGridViewCell this[int index] => (DataGridViewCell)mobjItems[index];

		/// Gets a list of elements in the collection.</summary>
		/// An <see cref="T:System.Collections.ArrayList"></see> containing the elements of the collection.</returns>
		...
		{
			return mobjItems.Add(objDataGridViewCell);
		}

		internal void AddCellLinkedList(DataGridViewCellLinkedList dataGridViewCells)
		{
			foreach (DataGridViewCell item in (IEnumerable)dataGridViewCells)
			{
				mobjItems.Add(item);
			}
		}
		...
		/// true if dataGridViewCell is in the <see cref="T:Gizmox.WebGUI.Forms.DataGridViewSelectedCellCollection"></see>; otherwise, false.</returns>
		...
		{
			return mobjItems.IndexOf(objDataGridViewCell) != -1;
		}

		/// Copies the elements of the collection to the specified <see cref="T:Gizmox.WebGUI.Forms.DataGridViewCell"></see> array, starting at the specified index.</summary>
		...
		/// Inserts a cell into the collection.</summary>
