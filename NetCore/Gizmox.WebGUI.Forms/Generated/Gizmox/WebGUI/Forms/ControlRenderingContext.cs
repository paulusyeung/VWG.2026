...
namespace Gizmox.WebGUI.Forms
{
	...
	public class ControlRenderingContext
	{
		...
		/// </summary>
		private Dictionary<string, System.Drawing.Image> mobjImageCache = new Dictionary<string, System.Drawing.Image>();

		/// 
		/// Gets the pixel format.
		/// </summary>
		public PixelFormat PixelFormat => menmPixelFormat;
		...
		/// </returns>
		internal System.Drawing.Image GetResourceImage(ResourceHandle objResourceHandle)
		{
			System.Drawing.Image value = null;
			if (objResourceHandle != null && objResourceHandle.CanGetImage)
			{
				string text = objResourceHandle.ToString();
				if (!string.IsNullOrEmpty(text) && !mobjImageCache.TryGetValue(text, out value))
				{
					try
					{
						value = objResourceHandle.ToImage();
					}
					catch
					{
					}
					mobjImageCache[text] = value;
				}
			}
			return value;
		}
