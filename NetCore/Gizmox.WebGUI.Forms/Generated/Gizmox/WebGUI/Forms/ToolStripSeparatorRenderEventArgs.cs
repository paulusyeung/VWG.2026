...
/// 
	...
	{
		/// Gets a value indicating whether the display style for the grip is vertical. </summary> 
		/// true if the display style for the <see cref="T:Gizmox.WebGUI.Forms.ToolStripSeparator"></see> is vertical; otherwise, false.</returns> 
		/// 1</filterpriority>
		[Obsolete("Not implemented. Added for migration compatibility")]
		[Browsable(false)]
		...
		/// Initializes a new instance of the <see cref="T:Gizmox.WebGUI.Forms.ToolStripSeparatorRenderEventArgs"></see> class. </summary> 
