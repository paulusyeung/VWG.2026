...
namespace Gizmox.WebGUI.Forms
{
	...
	public class ProxyActivateFormCommand : ProxyAction
	{
		...
		/// 
		/// Initializes a new instance of the <see cref="T:Gizmox.WebGUI.Forms.ProxyActivateFormCommand" /> class.
		/// </summary>
		...
		public override void Execute()
		{
			...
			if (context == null || !(context.ActiveForm.GetType() != FormType))
			{
				return;
			}
			...
			foreach (IForm item in list)
			{
				if (item is Form form && form.GetType() == FormType)
				{
