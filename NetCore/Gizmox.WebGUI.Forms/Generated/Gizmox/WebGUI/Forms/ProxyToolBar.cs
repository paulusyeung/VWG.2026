...
/// 
	...
	public class ProxyToolBar : ProxyControl
	{
		...
		{
			if (objComponent is ToolBar { Buttons: var buttons })
			{
				buttons.ObservableItemAdded += objButtons_ObservableItemAdded;
				buttons.ObservableItemInserted += objButtons_ObservableItemAdded;
				buttons.ObservableItemRemoved += objButtons_ObservableItemRemoved;
				buttons.ObservableListCleared += objButtons_ObservableListCleared;
			}
		}
		...
		private void AddContainedComponents(Component objComponent)
		{
			...
			foreach (ToolBarButton item in (IEnumerable)toolBar.Buttons)
			{
