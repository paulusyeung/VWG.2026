...
namespace Gizmox.WebGUI.Forms
{
	...
	public class DataGridViewColumnConverter : ExpandableObjectConverter
	{
		...
		public override object ConvertTo(ITypeDescriptorContext objContext, CultureInfo objCulture, object objValue, Type objDestinationType)
		{
			...
			DataGridViewColumn dataGridViewColumn = objValue as DataGridViewColumn;
			if (objDestinationType == typeof(InstanceDescriptor) && dataGridViewColumn != null)
			{
				object obj = ConvertToInstanceDescriptor(objContext, dataGridViewColumn);
				if (obj != null)
				{
					return obj;
				}
		...
		private object ConvertToInstanceDescriptor(ITypeDescriptorContext objContext, DataGridViewColumn objColumn)
		{
			...
			{
				constructor = objColumn.GetType().GetConstructor(new Type[1] { typeof(Type) });
				if (constructor != null)
				{
					return new InstanceDescriptor(constructor, new object[1] { objColumn.CellType }, isComplete: false);
				}
			}
			constructor = objColumn.GetType().GetConstructor(new Type[0]);
			if (constructor != null)
			{
