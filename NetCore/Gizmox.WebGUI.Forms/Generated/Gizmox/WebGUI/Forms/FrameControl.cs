...
namespace Gizmox.WebGUI.Forms
{
	...
	public abstract class FrameControl : Control
	{
		...
		public void InvokeClientMethod(string strMember, params object[] arrArgs)
		{
			...
			InvokeMethod("Remoting_ServerInvokeTargetMember", list.ToArray());
		}
		...
		protected override void RenderAttributes(IContext objContext, IAttributeWriter objWriter)
		{
			...
			if (!IsInline)
			{
				objWriter.WriteAttributeString("SR", Source);
			}
			else
			{
				objWriter.WriteAttributeText("SR", Source);
			}
			objWriter.WriteAttributeString("II", IsInline ? "1" : "0");
		}
	}
}
