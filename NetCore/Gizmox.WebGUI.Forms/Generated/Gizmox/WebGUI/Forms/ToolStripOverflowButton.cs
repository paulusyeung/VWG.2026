...
/// Hosts a <see cref="T:System.Windows.Forms.ToolStripDropDown"></see> that displays items that overflow the <see cref="T:System.Windows.Forms.ToolStrip"></see>.</summary>
	...
	{
		/// Gets a value indicating whether the <see cref="T:Gizmox.WebGUI.Forms.ToolStripOverflowButton"></see> has items that overflow the <see cref="T:Gizmox.WebGUI.Forms.ToolStrip"></see>.</summary> 
		/// true if the <see cref="T:Gizmox.WebGUI.Forms.ToolStripOverflowButton"></see> has overflow items; otherwise, false. </returns> 
		/// 1</filterpriority>
		[Obsolete("Not implemented. Added for migration compatibility")]
		...
		/// Retrieves the size of a rectangular area into which a control can fit.</summary>
