...
namespace Gizmox.WebGUI.Forms
{
	...
	{
		/// Gets or sets whether this event should be forwarded to the control's parent container.</summary>
		/// true if the mouse event should go to the parent control; otherwise, false.</returns>
		/// 1</filterpriority>
		public bool Handled
		{
			get
		...
		/// <param name="intY">The y.</param>
		/// <param name="intDelta">The delta.</param>
		/// <param name="blnDefaultHandledValue">if set to true</c> [default handled value].</param>
