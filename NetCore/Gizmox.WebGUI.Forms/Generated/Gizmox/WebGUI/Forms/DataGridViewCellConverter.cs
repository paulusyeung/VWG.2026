...
[Serializable]
	public class DataGridViewCellConverter : ExpandableObjectConverter
	{
		...
		public override object ConvertTo(ITypeDescriptorContext objContext, CultureInfo objCulture, object objValue, Type objDestinationType)
		{
			...
			DataGridViewCell dataGridViewCell = objValue as DataGridViewCell;
			if (objDestinationType == typeof(InstanceDescriptor) && dataGridViewCell != null)
			{
				object obj = ConvertToInstanceDescriptor(objContext, dataGridViewCell);
				if (obj != null)
				{
					return obj;
				}
