...
namespace Gizmox.WebGUI.Forms
{
	...
	public class CheckBoxRenderer : ButtonBaseRenderer
	{
		...
		{
			if (base.Control is CheckBox { Skin: CheckBoxSkin skin } checkBox)
			{
				ResourceHandle objResourceHandle = null;
				switch (checkBox.CheckState)
				{
				case CheckState.Checked:
					objResourceHandle = skin.GetResourceHandleFromReference(skin.CheckedCheckBoxImage);
					break;
				case CheckState.Indeterminate:
					objResourceHandle = skin.GetResourceHandleFromReference(skin.IndeterminateCheckBoxImage);
					break;
				case CheckState.Unchecked:
					objResourceHandle = skin.GetResourceHandleFromReference(skin.UnCheckedCheckBoxImage);
					break;
				}
