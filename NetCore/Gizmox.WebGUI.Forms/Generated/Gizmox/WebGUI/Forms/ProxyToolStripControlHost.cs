...
namespace Gizmox.WebGUI.Forms
{
	...
	public class ProxyToolStripControlHost : ProxyComponent
	{
		...
		{
			if (objComponent is ToolStripControlHost toolStripControlHost)
			{
				ProxyComponent proxyComponent = CreateProxyByComponent(toolStripControlHost.Control);
		...
		public void AttachProxy()
		{
			...
			{
				ProxyComponent proxyComponent = Components[0];
				Component sourceComponent = proxyComponent.SourceComponent;
				if (sourceComponent != null)
				{
					sourceComponent.ProxyComponent = proxyComponent;
				}
			}
		}
