...
/// 
	...
	public class ColumnHeaderGroupingData : IComparer
	{
		...
		public ICollection SortedColumns
		{
			get
			{
				ArrayList arrayList = new ArrayList(mobjListView.Columns);
				arrayList.Sort(this);
				return arrayList;
			}
		}
		...
		public ICollection GroupingColumns
		{
			get
			{
				...
				foreach (ColumnHeader sortedColumn in SortedColumns)
				{
					if (sortedColumn.GroupBy)
					{
						arrayList.Add(sortedColumn);
					}
				}
				return arrayList;
			}
		...
		{
			ColumnHeader columnHeader = objObjectA as ColumnHeader;
			ColumnHeader columnHeader2 = objObjectB as ColumnHeader;
			if (columnHeader.GroupByPosition > columnHeader2.GroupByPosition)
			{
				return 1;
			}
			if (columnHeader.GroupByPosition < columnHeader2.GroupByPosition)
