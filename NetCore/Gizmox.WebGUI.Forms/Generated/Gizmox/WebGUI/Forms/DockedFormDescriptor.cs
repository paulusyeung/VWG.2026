...
namespace Gizmox.WebGUI.Forms
{
	...
	public class DockedFormDescriptor : DockedObjectDescriptor
	{
		...
		public FormWindowState WindowState
		{
			get
			{
				return menmWindowState;
			}
			set
			{
				menmWindowState = value;
			}
		}
		...
		/// Gets the location.
		/// </summary>
		public Point Location => mobjLocation;
		...
		internal override void UpdateSelf(Control objControl, DockingManager objManager)
		{
			...
			menmWindowState = dockedForm.WindowState;
			mobjSize = dockedForm.Size;
			mobjLocation = dockedForm.Location;
		}
	}
}
