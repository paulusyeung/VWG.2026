...
namespace Gizmox.WebGUI.Forms
{
	...
	internal class ListManagerBindingsCollection : BindingsCollection
	{
		...
		{
			mobjBindingManagerBase = objBindingManagerBase;
		}
		...
		protected override void AddCore(Binding objDataBinding)
		{
			...
			if (objDataBinding.BindingManagerBase == mobjBindingManagerBase)
			{
			...
			objDataBinding.SetListManager(mobjBindingManagerBase);
