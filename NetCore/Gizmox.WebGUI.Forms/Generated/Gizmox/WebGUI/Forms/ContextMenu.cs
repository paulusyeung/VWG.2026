...
/// 
	...
	public class ContextMenu : Menu, IContextMenu
	{
		...
		/// </summary>
		/// 
		/// 	true</c> if the collapse event is registered; otherwise, false</c>.
		/// </value>
		...
		public Control SourceControl
		{
			get
			{
				...
				for (Component component = base.Owner; component != null; component = component.InternalParent)
				{
		...
		/// 
		/// Creates a new <see cref="T:Gizmox.WebGUI.Forms.ContextMenu" /> instance.
		/// </summary>
		public ContextMenu()
		{
		}
