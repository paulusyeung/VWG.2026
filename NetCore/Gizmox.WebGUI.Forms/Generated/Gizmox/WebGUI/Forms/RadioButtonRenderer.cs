...
/// 
	...
	public class RadioButtonRenderer : ButtonBaseRenderer
	{
		...
		{
			if (base.Control is RadioButton { Skin: RadioButtonSkin skin } radioButton)
			{
				ResourceHandle resourceHandle = null;
				resourceHandle = ((!radioButton.Checked) ? skin.GetResourceHandleFromReference(skin.UnCheckedRadioImage) : skin.GetResourceHandleFromReference(skin.CheckedRadioImage));
				objRegion = ControlRenderer.DockInRegion(objRegion, DockStyle.Left, ControlRenderer.RenderImage(objContext, objGraphics, resourceHandle, objRegion, ContentAlignment.MiddleLeft));
			}
