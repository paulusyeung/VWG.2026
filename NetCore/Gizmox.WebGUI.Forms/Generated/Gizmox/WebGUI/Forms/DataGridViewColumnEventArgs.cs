...
{
	/// Provides data for column-related events of a <see cref="T:Gizmox.WebGUI.Forms.DataGridView"></see>. </summary>
	/// 2</filterpriority>
	[Serializable]
	public class DataGridViewColumnEventArgs : EventArgs
	{
		...
		/// Gets the column that the event occurs for.</summary>
		/// The <see cref="T:Gizmox.WebGUI.Forms.DataGridViewColumn"></see> that the event occurs for.</returns>
		/// 1</filterpriority>
		public DataGridViewColumn Column => mobjDataGridViewColumn;

		/// Initializes a new instance of the <see cref="T:Gizmox.WebGUI.Forms.DataGridViewColumnEventArgs"></see> class. </summary>
