...
[Serializable]
	...
	{
		/// Gets or sets the new <see cref="P:Gizmox.WebGUI.Forms.ScrollBar.Value"></see> of the scroll bar.</summary> 
		/// The numeric value that the <see cref="P:Gizmox.WebGUI.Forms.ScrollBar.Value"></see> property will be changed to.</returns> 
		/// 1</filterpriority>
		[Obsolete("Not implemented. Added for migration compatibility")]
		[Browsable(false)]
		...
		/// Gets the old <see cref="P:Gizmox.WebGUI.Forms.ScrollBar.Value"></see> of the scroll bar.</summary> 
		/// The numeric value that the <see cref="P:Gizmox.WebGUI.Forms.ScrollBar.Value"></see> property contained before it changed.</returns> 
		/// 1</filterpriority>
		[Obsolete("Not implemented. Added for migration compatibility")]
		[Browsable(false)]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		...
		/// Gets the scroll bar orientation that raised the Scroll event.</summary> 
		/// One of the <see cref="T:Gizmox.WebGUI.Forms.ScrollOrientation"></see> values.</returns> 
		/// 1</filterpriority>
		[Obsolete("Not implemented. Added for migration compatibility")]
		[Browsable(false)]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		...
		/// Gets the type of scroll event that occurred.</summary> 
		/// One of the <see cref="T:Gizmox.WebGUI.Forms.ScrollEventType"></see> values.</returns> 
		/// 1</filterpriority>
		[Obsolete("Not implemented. Added for migration compatibility")]
		[Browsable(false)]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		...
		/// Initializes a new instance of the <see cref="T:Gizmox.WebGUI.Forms.ScrollEventArgs"></see> class using the given values for the <see cref="P:Gizmox.WebGUI.Forms.ScrollEventArgs.Type"></see> and <see cref="P:Gizmox.WebGUI.Forms.ScrollEventArgs.NewValue"></see> properties.</summary> 
