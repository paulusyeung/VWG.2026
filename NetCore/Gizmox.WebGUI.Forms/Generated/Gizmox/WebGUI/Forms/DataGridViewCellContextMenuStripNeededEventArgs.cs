...
namespace Gizmox.WebGUI.Forms
{
	...
	public class DataGridViewCellContextMenuStripNeededEventArgs : DataGridViewCellEventArgs
	{
		...
		/// Gets or sets the shortcut menu for the cell that raised the <see cref="E:System.Windows.Forms.DataGridView.CellContextMenuStripNeeded"></see> event.</summary>
		/// The <see cref="T:System.Windows.Forms.ContextMenuStrip"></see> for the cell. </returns>
		...
		/// Initializes a new instance of the <see cref="T:System.Windows.Forms.DataGridViewCellContextMenuStripNeededEventArgs"></see> class. </summary>
		...
		internal DataGridViewCellContextMenuStripNeededEventArgs(int intColumnIndex, int intRowIndex, ContextMenuStrip objContextMenuStrip)
			: base(intColumnIndex, intRowIndex)
		{
			mobjContextMenuStrip = objContextMenuStrip;
		}
	}
}
