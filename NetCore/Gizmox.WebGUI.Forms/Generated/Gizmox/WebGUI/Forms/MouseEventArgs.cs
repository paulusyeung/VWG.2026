...
namespace Gizmox.WebGUI.Forms
{
	...
	public class MouseEventArgs : EventArgs
	{
		...
		/// </summary>
		/// The button.</value>
		public MouseButtons Button => menmButton;

		/// 
		/// Gets the number of times the mouse button was pressed and released.
		/// </summary>
		/// The clicks.</value>
		public int Clicks => mintClicks;

		/// 
		/// Gets a signed count of the number of detents the mouse wheel has rotated. A detent is one notch of the mouse wheel.
		/// </summary>
		/// The delta.</value>
		public int Delta => mintDelta;

		/// Gets the location of the mouse during the generating mouse event.</summary>
		/// A <see cref="T:System.Drawing.Point"></see> containing the x- and y- coordinate of the mouse, in pixels.</returns>
		/// 1</filterpriority>
		...
		{
			menmButton = enmButton;
			mintClicks = intClicks;
			mintX = intX;
			mintY = intY;
			mintDelta = intDelta;
		}
