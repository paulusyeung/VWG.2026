...
/// 
	...
	{
		/// 
		/// Initializes a new instance of the <see cref="T:Gizmox.WebGUI.Forms.LayoutEngine" /> class.
		/// </summary>
		...
		{
			InitLayoutCore(CastToArrangedElement(objChild), enmSpecified);
		}
		...
		{
			return LayoutCore(CastToArrangedElement(objContainer), objLayoutEventArgs);
		}
		...
		internal IArrangedElement CastToArrangedElement(object obj)
		{
			...
			if (obj == null)
			{
				throw new NotSupportedException(SR.GetString("LayoutEngineUnsupportedType", obj.GetType()));
			}
			return result;
		}
