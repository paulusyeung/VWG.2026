...
/// Defines constants that inform <see cref="M:System.Windows.Forms.ContainerControl.ValidateChildren(System.Windows.Forms.ValidationConstraints)"></see> about how it should validate a container's child controls. </summary>
	...
	{
		/// Validates child controls whose <see cref="P:System.Windows.Forms.Control.Enabled"></see> property is set to true.</summary>
		Enabled = 2,
		...
		/// Validates all child controls, and all children of these child controls, regardless of their property settings. </summary>
		None = 0,
		/// Validates child controls that can be selected.</summary>
		Selectable = 1,
		/// Validates child controls that have a <see cref="P:System.Windows.Forms.Control.TabStop"></see> value set, which means that the user can navigate to the control using the TAB key. </summary>
		TabStop = 8,
		/// Validates child controls whose <see cref="P:System.Windows.Forms.Control.Visible"></see> property is set to true.</summary>
		Visible = 4
	}
}
