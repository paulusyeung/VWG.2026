...
/// Specifies the direction to move when getting items with the <see cref="M:Gizmox.WebGUI.Forms.ToolStrip.GetNextItem(Gizmox.WebGUI.Forms.ToolStripItem,Gizmox.WebGUI.Forms.ArrowDirection)"></see> method.</summary>
	public enum ArrowDirection
	{
		...
		Down = 17,
		/// The direction is left (<see cref="F:Gizmox.WebGUI.Forms.Orientation.Horizontal"></see>).</summary>
		Left = 0,
		/// The direction is right (<see cref="F:Gizmox.WebGUI.Forms.Orientation.Horizontal"></see>).</summary>
		Right = 16,
		/// The direction is left (<see cref="F:Gizmox.WebGUI.Forms.Orientation.Vertical"></see>).</summary>
		Up = 1
	}
}
