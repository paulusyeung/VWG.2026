...
namespace Gizmox.WebGUI.Forms
{
	...
	public class ComboBoxRenderer : ControlRenderer
	{
		...
		{
			if (base.Control is ComboBox comboBox)
			{
				ControlRenderer.RenderText(objContext, objGraphics, comboBox.Text, comboBox.Font, comboBox.ForeColor, comboBox.Size, HorizontalAlignment.Left, blnWrapText: true);
			}
		}
	}
}
