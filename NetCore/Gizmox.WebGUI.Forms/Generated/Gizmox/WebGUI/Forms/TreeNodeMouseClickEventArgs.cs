...
namespace Gizmox.WebGUI.Forms
{
	...
	public class TreeNodeMouseClickEventArgs : MouseEventArgs
	{
		...
		/// Gets the node that was clicked.</summary>
		/// The <see cref="T:Gizmox.WebGUI.Forms.TreeNode"></see> that was clicked.</returns>
		/// 1</filterpriority>
		public TreeNode Node => mobjNode;

		/// Initializes a new instance of the <see cref="T:Gizmox.WebGUI.Forms.TreeNodeMouseClickEventArgs"></see> class. </summary>
