...
namespace Gizmox.WebGUI.Forms
{
	...
	public class DataGridViewCellContextMenuNeededEventArgs : DataGridViewCellEventArgs
	{
		...
		/// Gets or sets the shortcut menu for the cell that raised the <see cref="E:System.Windows.Forms.DataGridView.CellContextMenuNeeded"></see> event.</summary>
		/// The <see cref="T:System.Windows.Forms.ContextMenu"></see> for the cell. </returns>
		...
		/// Initializes a new instance of the <see cref="T:System.Windows.Forms.DataGridViewCellContextMenuNeededEventArgs"></see> class. </summary>
		...
		internal DataGridViewCellContextMenuNeededEventArgs(int intColumnIndex, int intRowIndex, ContextMenu objContextMenu)
			: base(intColumnIndex, intRowIndex)
		{
			mobjContextMenu = objContextMenu;
		}
	}
}
