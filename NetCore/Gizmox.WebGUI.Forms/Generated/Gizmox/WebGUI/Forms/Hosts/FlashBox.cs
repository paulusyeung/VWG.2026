...
namespace Gizmox.WebGUI.Forms.Hosts
{
	...
	public class FlashBox : FlashBoxBase
	{
		...
		public string Movie
		{
			get
			{
				return base.InternalMovie;
			}
			set
			{
				base.InternalMovie = value;
			}
		}
		...
		/// 
		/// Creates a new <see cref="T:Gizmox.WebGUI.Forms.Hosts.FlashBox" /> instance.
		/// </summary>
		public FlashBox()
		{
		}
		...
		/// Adds the parameter.
		/// </summary>
		public new void AddParameter(string strName, string strValue)
		{
			base.Parameters[strName] = strValue;
		}

		/// 
		/// Adds the parameter.
		/// </summary>
		public new void AddParameter(string strName, GatewayHandler objHandler)
		{
			base.Parameters[strName] = objHandler;
		}

		/// 
		/// Gets the parameter.
		/// </summary>
		public new string GetParameter(string strName)
		{
			return base.Parameters[strName] as string;
		}
		...
		{
			if (base.Parameters.Contains(strName))
			{
				base.Parameters.Remove(strName);
			}
		}
