...
{
/// Provides data for the <see cref="E:Gizmox.WebGUI.Forms.DataGridView.CellToolTipTextNeeded"></see> event. </summary>
	[Serializable]
	public class DataGridViewCellToolTipTextNeededEventArgs : DataGridViewCellEventArgs
	{
		private string mstrToolTipText;

		/// Gets or sets the ToolTip text.</summary>
		/// The current ToolTip text.</returns>
		...
		{
			mstrToolTipText = strToolTipText;
		}
	}
}
