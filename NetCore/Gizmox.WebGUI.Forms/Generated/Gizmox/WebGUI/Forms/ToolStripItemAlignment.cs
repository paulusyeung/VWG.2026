...
namespace Gizmox.WebGUI.Forms
{
	...
	{
		/// Specifies that the <see cref="T:Gizmox.WebGUI.Forms.ToolStripItem"></see> is to be anchored toward the left or top end of the <see cref="T:Gizmox.WebGUI.Forms.ToolStrip"></see>, depending on the <see cref="T:Gizmox.WebGUI.Forms.ToolStrip"></see> orientation. If the value of <see cref="T:Gizmox.WebGUI.Forms.RightToLeft"></see> is Yes, items marked as <see cref="F:Gizmox.WebGUI.Forms.ToolStripItemAlignment.Left"></see> are aligned to the right side of the <see cref="T:Gizmox.WebGUI.Forms.ToolStrip"></see>.</summary>
		Left,
		/// Specifies that the <see cref="T:Gizmox.WebGUI.Forms.ToolStripItem"></see> is to be anchored toward the right or bottom end of the <see cref="T:Gizmox.WebGUI.Forms.ToolStrip"></see>, depending on the <see cref="T:Gizmox.WebGUI.Forms.ToolStrip"></see> orientation. If the value of <see cref="T:Gizmox.WebGUI.Forms.RightToLeft"></see> is Yes, items marked as <see cref="F:Gizmox.WebGUI.Forms.ToolStripItemAlignment.Right"></see> are aligned to the left side of the <see cref="T:Gizmox.WebGUI.Forms.ToolStrip"></see>.</summary>
		Right
	}
}
