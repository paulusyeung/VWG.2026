...
{
/// Provides data for the <see cref="E:Gizmox.WebGUI.Forms.DataGridView.EditingControlShowing"></see> event.</summary>
	/// 2</filterpriority>
	[Serializable]
	public class DataGridViewEditingControlShowingEventArgs : EventArgs
	{
		...
		/// Gets or sets the cell style of the edited cell.</summary>
		/// A <see cref="T:Gizmox.WebGUI.Forms.DataGridViewCellStyle"></see> representing the style of the cell being edited.</returns>
		...
		/// The control shown to the user for editing the selected cell's value.</summary>
		/// A <see cref="T:Gizmox.WebGUI.Forms.Control"></see> that displays an area for the user to enter or change the selected cell's value.</returns>
		/// 1</filterpriority>
		public Control Control => mobjControl;

		/// Initializes a new instance of the <see cref="T:Gizmox.WebGUI.Forms.DataGridViewEditingControlShowingEventArgs"></see> class.</summary>
