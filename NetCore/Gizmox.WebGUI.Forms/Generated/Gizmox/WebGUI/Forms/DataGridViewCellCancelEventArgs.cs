...
[Serializable]
	public class DataGridViewCellCancelEventArgs : CancelEventArgs
	{
		...
		/// Gets the column index of the cell that the event occurs for.</summary>
		/// The column index of the <see cref="T:Gizmox.WebGUI.Forms.DataGridViewCell"></see> that the event occurs for.</returns>
		/// 1</filterpriority>
		public int ColumnIndex => mintColumnIndex;

		/// Gets the row index of the cell that the event occurs for.</summary>
		/// The row index of the <see cref="T:Gizmox.WebGUI.Forms.DataGridViewCell"></see> that the event occurs for.</returns>
		/// 1</filterpriority>
		...
		/// Initializes a new instance of the <see cref="T:Gizmox.WebGUI.Forms.DataGridViewCellCancelEventArgs"></see> class. </summary>
