...
/// 
	...
	internal class ZoneDescriptor : DockedObjectDescriptor
	{
		...
		public DockStyle DockingPosition
		{
			get
			{
				return menmDockingPosition;
			}
			set
			{
				menmDockingPosition = value;
			}
		}
		...
		public ZoneDescriptor(ZoneDescriptor objZoneDescriptor)
			: this()
		{
			mintPanelSide = objZoneDescriptor.mintPanelSide;
		}
		...
		{
			mintPanelSide = -1;
			menmDockingPosition = DockStyle.None;
		}
		...
		{
			if (base.ParentDescriptor != null && base.ParentDescriptor is DockedSplitContainerDescriptor dockedSplitContainerDescriptor)
			{
				dockedSplitContainerDescriptor.NotifyZoneIsEmpty(PanelSide);
			}
		}
