...
namespace Gizmox.WebGUI.Forms
{
	...
	public class SplitterCancelEventArgs : CancelEventArgs
	{
		...
		/// </summary>
		/// The mouse cursor X.</value>
		public int MouseCursorX => mintMouseCursorX;

		/// 
		/// Gets the Y coordinate of the mouse pointer in client coordinates.
		/// </summary>
		/// The mouse cursor Y.</value>
		public int MouseCursorY => mintMouseCursorY;
		...
		public SplitterCancelEventArgs(int intMouseCursorX, int intMouseCursorY, int intSplitX, int intSplitY)
			: base(cancel: false)
		{
			mintMouseCursorX = intMouseCursorX;
			mintMouseCursorY = intMouseCursorY;
			mintSplitX = intSplitX;
			mintSplitY = intSplitY;
		}
	}
}
