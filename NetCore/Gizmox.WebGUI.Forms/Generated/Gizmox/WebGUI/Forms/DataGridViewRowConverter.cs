...
[Serializable]
	public class DataGridViewRowConverter : ExpandableObjectConverter
	{
		...
		public override object ConvertTo(ITypeDescriptorContext objContext, CultureInfo objCulture, object objValue, Type objDestinationType)
		{
			...
			DataGridViewRow dataGridViewRow = objValue as DataGridViewRow;
			if (objDestinationType == typeof(InstanceDescriptor) && dataGridViewRow != null)
			{
				InstanceDescriptor instanceDescriptor = ConvertToInstanceDescriptor(dataGridViewRow);
