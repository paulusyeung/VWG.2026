...
/// 
	...
	public class ProxyPropertyBag : Dictionary<string, object>
	{
		...
		internal event UiPropertyValueChangedEventHandler PropertyValueChanging
		{
			add
			{
				mobjPropertyValueChangedEventHandler = (UiPropertyValueChangedEventHandler)Delegate.Combine(mobjPropertyValueChangedEventHandler, value);
			}
			remove
			{
				mobjPropertyValueChangedEventHandler = (UiPropertyValueChangedEventHandler)Delegate.Remove(mobjPropertyValueChangedEventHandler, value);
			}
		}
		...
		[Obsolete("Overrides legacy obsolete Dictionary serialization member for compatibility.")]
