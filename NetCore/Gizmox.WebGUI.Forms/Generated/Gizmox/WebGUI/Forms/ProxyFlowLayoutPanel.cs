...
{
/// 
	/// Proxy FlowLayoutPanel
	/// </summary>
	[Serializable]
	[ToolboxItem(false)]
	public class ProxyFlowLayoutPanel : ProxyControl
	{
		/// 
		/// Initializes a new instance of the <see cref="T:Gizmox.WebGUI.Forms.ProxyFlowLayoutPanel" /> class.
		/// </summary>
		public ProxyFlowLayoutPanel()
		{
		}
		...
		public ProxyFlowLayoutPanel(Component objComponent, ProxyComponent objParent, bool blnStateComponent)
