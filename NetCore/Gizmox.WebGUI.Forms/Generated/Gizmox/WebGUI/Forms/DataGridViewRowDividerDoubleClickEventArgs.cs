...
{
/// Provides data for the <see cref="E:Gizmox.WebGUI.Forms.DataGridView.RowDividerDoubleClick"></see> event of a <see cref="T:Gizmox.WebGUI.Forms.DataGridView"></see>. </summary>
	[Serializable]
	public class DataGridViewRowDividerDoubleClickEventArgs : HandledMouseEventArgs
	{
		private int mintRowIndex;

		/// The index of the row above the row divider that was double-clicked.</summary>
		/// The index of the row above the divider.</returns>
		public int RowIndex => mintRowIndex;

		/// Initializes a new instance of the <see cref="T:Gizmox.WebGUI.Forms.DataGridViewRowDividerDoubleClickEventArgs"></see> class. </summary>
