...
{
/// Provides data for the <see cref="E:Gizmox.WebGUI.Forms.DataGridView.CellStateChanged"></see> event. </summary>
	/// 2</filterpriority>
	[Serializable]
	public class DataGridViewCellStateChangedEventArgs : EventArgs
	{
		...
		/// Gets the <see cref="T:Gizmox.WebGUI.Forms.DataGridViewCell"></see> that has a changed state.</summary>
		/// The <see cref="T:Gizmox.WebGUI.Forms.DataGridViewCell"></see> whose state has changed.</returns>
		/// 1</filterpriority>
		public DataGridViewCell Cell => mobjDataGridViewCell;

		/// Gets the state that has changed on the cell.</summary>
		/// One of the <see cref="T:Gizmox.WebGUI.Forms.DataGridViewElementStates"></see> values indicating the state that has changed on the cell.</returns>
		public DataGridViewElementStates StateChanged => menmElementStateChanged;

		/// Initializes a new instance of the <see cref="T:Gizmox.WebGUI.Forms.DataGridViewCellStateChangedEventArgs"></see> class. </summary>
		...
		public DataGridViewCellStateChangedEventArgs(DataGridViewCell objDataGridViewCell, DataGridViewElementStates enmElementStateChanged)
		{
			...
			menmElementStateChanged = enmElementStateChanged;
		}
	}
}
