...
/// 
	...
	public class ColorEditor : WebUITypeEditor
	{
		...
		protected Color PropertyValue => mobjPropertyValue;
		...
		{
			ColorEditorDropDown colorEditorDropDown = new ColorEditorDropDown();
			colorEditorDropDown.Color = (Color)GetEditorValueFromPropertyValue(objValue);
			colorEditorDropDown.Closed += objColorDialog_Closed;
			mobjPropertyValue = colorEditorDropDown.Color;
			mobjHandler = objHandler;
			if (objProvider.GetService(typeof(IWebUIEditorService)) is IWebUIEditorService webUIEditorService)
			{
				webUIEditorService.ShowDropDown(colorEditorDropDown);
			}
		}
		...
		private void objColorDialog_Closed(object sender, EventArgs e)
		{
			...
			if (colorEditorDropDown.IsCompleted && mobjHandler != null)
			{
				object obj = null;
				try
				{
					obj = GetPropertyValueFromEditorValue(colorEditorDropDown.Color);
				}
