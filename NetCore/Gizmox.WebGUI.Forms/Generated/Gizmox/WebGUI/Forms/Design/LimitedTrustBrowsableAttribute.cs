...
/// 
	...
	public sealed class LimitedTrustBrowsableAttribute : Attribute
	{
		...
		/// </returns>
		public bool Browsable => mblnBrowsable;
		...
		{
			mblnBrowsable = blnBrowsable;
		}

		static LimitedTrustBrowsableAttribute()
		{
			No = new LimitedTrustBrowsableAttribute(blnBrowsable: false);
			Yes = new LimitedTrustBrowsableAttribute(blnBrowsable: true);
			Default = Yes;
		}

		/// Indicates whether this instance and a specified object are equal.</summary>
		/// true if obj is equal to this instance; otherwise, false.</returns>
		...
		public override bool Equals(object obj)
		{
			...
			return obj is LimitedTrustBrowsableAttribute limitedTrustBrowsableAttribute && limitedTrustBrowsableAttribute.Browsable == mblnBrowsable;
		}
		...
		{
			return mblnBrowsable.GetHashCode();
		}
