...
namespace Gizmox.WebGUI.Forms.Skins
{
	...
	public class MenuStripSkin : ToolStripSkin
	{
		...
		public virtual PaddingValue PaddingWithGrip
		{
			get
			{
				return GetValue("PaddingWithGrip", (PaddingValue)new Padding(3, 2, 0, 2));
			}
			set
			{
				SetValue("PaddingWithGrip", value);
			}
		}
		...
		public virtual PaddingValue PaddingWithOutGrip
		{
			get
			{
				return GetValue("PaddingWithOutGrip", (PaddingValue)new Padding(6, 2, 0, 2));
			}
			set
			{
				SetValue("PaddingWithOutGrip", value);
			}
		}
