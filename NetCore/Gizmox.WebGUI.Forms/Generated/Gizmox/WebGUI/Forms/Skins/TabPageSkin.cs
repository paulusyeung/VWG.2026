...
namespace Gizmox.WebGUI.Forms.Skins
{
	...
	public class TabPageSkin : ControlSkin
	{
		...
		public Font HeaderFont
		{
			get
			{
				return GetAmbientValue("HeaderFont", new Font("Tahoma", 8.25f));
			}
			set
			{
				SetValue("HeaderFont", value);
			}
		}
		...
		/// </summary>
		/// </value>
		/// HeaderForeColor is defined as an ambient property which means that in inherits from is container.</remarks>
		[Category("Colors")]
		...
		public Color HeaderForeColor
		{
			get
			{
				return GetAmbientValue("HeaderForeColor", Color.Black);
			}
			set
			{
				SetValue("HeaderForeColor", value);
			}
		}
