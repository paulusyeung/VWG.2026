...
namespace Gizmox.WebGUI.Forms.Skins
{
	...
	public class FrameStyleValue
	{
		...
		public StyleValue CenterStyle => mobjCenterStyle;

		/// 
		/// Gets the top style.
		/// </summary>
		/// The top style.</value>
		public FramePartStyleValue TopStyle => mobjTopStyle;

		/// 
		/// Gets the bottom style.
		/// </summary>
		/// The bottom style.</value>
		public FramePartStyleValue BottomStyle => mobjBottomStyle;

		/// 
		/// Gets the left style.
		/// </summary>
		/// The left style.</value>
		public FramePartStyleValue LeftStyle => mobjLeftStyle;

		/// 
		/// Gets the left top style.
		/// </summary>
		/// The left top style.</value>
		public FramePartStyleValue LeftTopStyle => mobjLeftTopStyle;

		/// 
		/// Gets the left bottom style.
		/// </summary>
		/// The left bottom style.</value>
		public FramePartStyleValue LeftBottomStyle => mobjLeftBottomStyle;

		/// 
		/// Gets the right style.
		/// </summary>
		/// The right style.</value>
		public FramePartStyleValue RightStyle => mobjRightStyle;

		/// 
		/// Gets the right top style.
		/// </summary>
		/// The right top style.</value>
		public FramePartStyleValue RightTopStyle => mobjRightTopStyle;

		/// 
		/// Gets the right bottom style.
		/// </summary>
		/// The right bottom style.</value>
		public FramePartStyleValue RightBottomStyle => mobjRightBottomStyle;
		...
		public FrameStyleValue(FramePartStyleValue objLeftBottomStyle, FramePartStyleValue objLeftStyle, FramePartStyleValue objLeftTopStyle, FramePartStyleValue objTopStyle, FramePartStyleValue objRightTopStyle, FramePartStyleValue objRightStyle, FramePartStyleValue objRightBottomStyle, FramePartStyleValue objBottomStyle, StyleValue objCenterStyle)
		{
