...
namespace Gizmox.WebGUI.Forms.Skins
{
	...
	public class StatusStripSkin : ToolStripSkin
	{
		...
		public virtual PaddingValue VerticalOrientationPadding
		{
			get
			{
				return GetValue("VerticalOrientationPadding", (PaddingValue)new Padding(1, 3, 1, 3));
			}
			set
			{
				SetValue("VerticalOrientationPadding", value);
			}
		}
		...
		public PaddingValue HorizontalOrientationPadding
		{
			get
			{
				return GetValue("HorizontalOrientationPadding", (PaddingValue)new Padding(1, 0, 14, 0));
			}
			set
			{
				SetValue("HorizontalOrientationPadding", value);
			}
		}
		...
		{
			Reset("VerticalOrientationPadding");
		}
		...
		{
			Reset("HorizontalOrientationPadding");
		}
	}
}
