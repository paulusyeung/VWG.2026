...
namespace Gizmox.WebGUI.Forms.Skins
{
	...
	public class SelectedIndicatorStyleValueConverter : TypeConverter
	{
		...
		{
			PropertyDescriptorCollection properties = TypeDescriptor.GetProperties(typeof(SelectedIndicatorStyleValue), arrAttributes);
			string[] names = new string[8] { "LeftBottomStyle", "LeftStyle", "LeftTopStyle", "TopStyle", "RightTopStyle", "RightStyle", "RightBottomStyle", "BottomStyle" };
