...
namespace Gizmox.WebGUI.Forms.Skins
{
	...
	public class HeaderedFrameStyleValueConverter : FrameStyleValueConverter
	{
		...
		{
			PropertyDescriptorCollection properties = TypeDescriptor.GetProperties(typeof(HeaderedFrameStyleValue), arrAttributes);
			string[] names = new string[12]
			{
				"HeaderLeftStyle", "HeaderCenterStyle", "HeaderRightStyle", "LeftBottomStyle", "LeftStyle", "LeftTopStyle", "TopStyle", "RightTopStyle", "RightStyle", "RightBottomStyle",
				"BottomStyle", "CenterStyle"
			};
