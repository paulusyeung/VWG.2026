...
/// 
	...
	public class SelectedIndicatorStyleValue
	{
		...
		/// </summary>
		/// The top style.</value>
		public StyleValue TopStyle => mobjTopStyle;

		/// 
		/// Gets the bottom style.
		/// </summary>
		/// The bottom style.</value>
		public StyleValue BottomStyle => mobjBottomStyle;

		/// 
		/// Gets the left style.
		/// </summary>
		/// The left style.</value>
		public StyleValue LeftStyle => mobjLeftStyle;

		/// 
		/// Gets the left top style.
		/// </summary>
		/// The left top style.</value>
		public StyleValue LeftTopStyle => mobjLeftTopStyle;

		/// 
		/// Gets the left bottom style.
		/// </summary>
		/// The left bottom style.</value>
		public StyleValue LeftBottomStyle => mobjLeftBottomStyle;

		/// 
		/// Gets the right style.
		/// </summary>
		/// The right style.</value>
		public StyleValue RightStyle => mobjRightStyle;

		/// 
		/// Gets the right top style.
		/// </summary>
		/// The right top style.</value>
		public StyleValue RightTopStyle => mobjRightTopStyle;

		/// 
		/// Gets the right bottom style.
		/// </summary>
		/// The right bottom style.</value>
		public StyleValue RightBottomStyle => mobjRightBottomStyle;
		...
		public SelectedIndicatorStyleValue(StyleValue objLeftBottomStyle, StyleValue objLeftStyle, StyleValue objLeftTopStyle, StyleValue objTopStyle, StyleValue objRightTopStyle, StyleValue objRightStyle, StyleValue objRightBottomStyle, StyleValue objBottomStyle)
		{
