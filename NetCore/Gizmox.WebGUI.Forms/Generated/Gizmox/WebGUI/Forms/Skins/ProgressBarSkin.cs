...
namespace Gizmox.WebGUI.Forms.Skins
{
	...
	public class ProgressBarSkin : ControlSkin
	{
		...
		/// </value>
		public virtual StyleValue ProgressBarNormalStyle => new StyleValue(this, "ProgressBarNormalStyle");
		...
		/// The control disabled style.
		/// </value>
		public virtual StyleValue ProgressBarBarStyle => new StyleValue(this, "ProgressBarBarStyle");
		...
		public int ProgressMinimumStartWidth
		{
			get
			{
				return GetValue("ProgressMinimumStartWidth", 0);
			}
			set
			{
				SetValue("ProgressMinimumStartWidth", value);
			}
		}
		...
		public ImageResourceReference ProgressBarImageLeft
		{
			get
			{
				return GetValue("ProgressBarImageLeft", ImageResourceReference.Empty);
			}
			set
			{
				SetValue("ProgressBarImageLeft", value);
			}
		}
		...
		/// </value>
		[Browsable(false)]
		public int ProgressBarImageLeftWidth => GetImageWidth(ProgressBarImageLeft, 0);
		...
		public ImageResourceReference ProgressBarImageRight
		{
			get
			{
				return GetValue("ProgressBarImageRight", ImageResourceReference.Empty);
			}
			set
			{
				SetValue("ProgressBarImageRight", value);
			}
		}
		...
		/// </value>
		[Browsable(false)]
		public int ProgressBarImageLeftRight => GetImageWidth(ProgressBarImageRight, 0);
