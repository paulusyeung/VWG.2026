...
/// 
	...
	public class FrameStyleValueConverter : TypeConverter
	{
		...
		{
			PropertyDescriptorCollection properties = TypeDescriptor.GetProperties(typeof(FrameStyleValue), arrAttributes);
			string[] names = new string[9] { "LeftBottomStyle", "LeftStyle", "LeftTopStyle", "TopStyle", "RightTopStyle", "RightStyle", "RightBottomStyle", "BottomStyle", "CenterStyle" };
