...
/// 
	...
	/// </summary>
	[Serializable]
	[TypeConverter(typeof(LoadingMessageStyleConverter))]
	public class LoadingMessageStyle
	{
		...
		public class LoadingMessageStyleConverter : TypeConverter
		{
			...
			{
				PropertyDescriptorCollection properties = TypeDescriptor.GetProperties(typeof(LoadingMessageStyle), arrAttributes);
				string[] names = new string[3] { "MessageStyle", "MessageHorizontalAlignment", "MessageVerticalAlignment" };
		...
		/// </summary>
		/// The message horizontal alignment.</value>
		public HorizontalAlignmentValue MessageHorizontalAlignment
		{
			get
			{
				return menmMessageHorizontalAlignment;
			}
			set
			{
				menmMessageHorizontalAlignment = value;
			}
		}
		...
		public StyleValue MessageStyle
		{
			get
			{
				return mobjMessageStyle;
			}
			set
			{
				mobjMessageStyle = value;
			}
		}
		...
		/// </summary>
		/// The message vertical alignment.</value>
		public VerticalAlignmentValue MessageVerticalAlignment
		{
			get
			{
				return menmMessageVerticalAlignment;
			}
			set
			{
				menmMessageVerticalAlignment = value;
			}
		}
