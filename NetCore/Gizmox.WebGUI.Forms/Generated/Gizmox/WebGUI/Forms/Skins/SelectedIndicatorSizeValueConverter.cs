...
namespace Gizmox.WebGUI.Forms.Skins
{
	...
	public class SelectedIndicatorSizeValueConverter : TypeConverter
	{
		...
		{
			PropertyDescriptorCollection properties = TypeDescriptor.GetProperties(typeof(SelectedIndicatorSizeValue), arrAttributes);
			string[] names = new string[8] { "LeftBottomSize", "LeftSize", "LeftTopSize", "TopSize", "RightTopSize", "RightSize", "RightBottomSize", "BottomSize" };
