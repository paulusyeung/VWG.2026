...
namespace Gizmox.WebGUI.Forms.Skins
{
	...
	public class LinkLabelSkin : LabelSkin
	{
		...
		public virtual Color LinkColor
		{
			get
			{
				return GetValue("LinkColor", DefaultLinkColor);
			}
			set
			{
		...
		public virtual Color LinkColorDisabled
		{
			get
			{
				return GetValue("LinkColorDisabled", DefaultLinkColorDisabled);
			}
			set
			{
				SetValue("LinkColorDisabled", value);
			}
		}
		...
		/// </summary>
		/// The default link color disabled.</value>
		protected virtual Color DefaultLinkColorDisabled => Color.FromArgb(169, 169, 169);

		/// 
		/// Gets the Content style.
		/// </summary>
		/// The Content style.</value>
		public virtual StyleValue ContentStyle => new StyleValue(this, "ContentStyle");

		/// 
		/// Gets the focused style.
		/// </summary>
		/// The focused style.</value>
		public virtual StyleValue FocusedStyle => new StyleValue(this, "FocusedStyle");
