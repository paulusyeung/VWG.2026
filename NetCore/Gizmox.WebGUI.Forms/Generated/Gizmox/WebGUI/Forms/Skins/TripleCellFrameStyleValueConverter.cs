...
/// 
	...
	public class TripleCellFrameStyleValueConverter : TypeConverter
	{
		...
		{
			PropertyDescriptorCollection properties = TypeDescriptor.GetProperties(typeof(TripleCellFrameStyleValue), arrAttributes);
			string[] names = new string[3] { "LeftStyle", "RightStyle", "CenterStyle" };
