...
namespace Gizmox.WebGUI.Forms.Skins
{
	...
	public class HeaderedFrameStyleValue : FrameStyleValue
	{
		...
		/// </summary>
		/// The header left style.</value>
		public StyleValue HeaderLeftStyle => mobjHeaderLeftStyle;

		/// 
		/// Gets the header center style.
		/// </summary>
		/// The header center style.</value>
		public StyleValue HeaderCenterStyle => mobjHeaderCenterStyle;

		/// 
		/// Gets the header right style.
		/// </summary>
		/// The header right style.</value>
		public StyleValue HeaderRightStyle => mobjHeaderRightStyle;
