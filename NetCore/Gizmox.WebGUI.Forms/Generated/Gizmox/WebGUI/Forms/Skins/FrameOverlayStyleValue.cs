	...
	public class FrameOverlayStyleValue : FramePartStyleValue
	{
		...
		protected virtual BackgroundImagePosition DefaultBackgroundImagePosition
		{
			get
			{
				...
				{
					return ((FrameOverlayStyleValue)base.Defaults).BackgroundImagePosition;
				}
		...
		{
			if (HasBackgroundImagePosition)
			{
				string importantDeclarationValue = objValueDefinition.GetImportantDeclarationValue(objContext);
				return $"background-position:{BackgroundValue.GetCSSValue(BackgroundImagePosition)}{importantDeclarationValue};{base.GetValue(objContext, objValueDefinition)}";
			}
