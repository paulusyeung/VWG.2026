...
/// 
	...
	public class DataGridViewComboBoxCellSkin : ComboBoxSkin
	{
		...
		public virtual StyleValue CellNormalStyle => new StyleValue(this, "CellNormalStyle", blnIsAmbientValues: true);

		/// 
		/// Gets or sets the color of the normal fore.
		/// </summary>
		/// The color of the normal fore.</value>
		[Browsable(false)]
		[EditorBrowsable(EditorBrowsableState.Never)]
		public Color NormalForeColor => CellNormalStyle.ForeColor;
