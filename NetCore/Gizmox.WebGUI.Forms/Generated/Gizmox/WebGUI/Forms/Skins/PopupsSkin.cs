...
namespace Gizmox.WebGUI.Forms.Skins
{
	...
	public class PopupsSkin : CommonSkin
	{
		...
		public int TopFrameHeight
		{
			get
			{
				return GetValue("TopFrameHeight", GetImageWidth(LeftTopStyle.BackgroundImage, 0));
			}
			set
			{
		...
		public int RightFrameWidth
		{
			get
			{
				return GetValue("RightFrameWidth", GetImageWidth(RightTopStyle.BackgroundImage, 0));
			}
			set
			{
		...
		public int BottomFrameHeight
		{
			get
			{
				return GetValue("BottomFrameHeight", GetImageWidth(LeftBottomStyle.BackgroundImage, 0));
			}
			set
			{
		...
		public int LeftFrameWidth
		{
			get
			{
				return GetValue("LeftFrameWidth", GetImageWidth(LeftBottomStyle.BackgroundImage, 0));
			}
			set
			{
		...
		/// </summary>
		/// The popup left top style.</value>
		[Browsable(false)]
		...
		/// </summary>
		/// The popup right top style.</value>
		[Browsable(false)]
		[EditorBrowsable(EditorBrowsableState.Never)]
		...
		/// </summary>
		/// The popup left bottom style.</value>
		[Browsable(false)]
		[EditorBrowsable(EditorBrowsableState.Never)]
		...
		/// </summary>
		/// The popup right bottom style.</value>
		[Browsable(false)]
		[EditorBrowsable(EditorBrowsableState.Never)]
		...
		public virtual PaddingValue ContentPadding
		{
			get
			{
				return GetValue("ContentPadding", PaddingValue.Empty);
			}
			set
			{
				SetValue("ContentPadding", value);
			}
		}
		...
		public new string BoxShadowPopupOffset
		{
			get
			{
				...
				string text3 = "0";
				string text4 = "0";
				if (CenterStyle.BorderStyle != BorderStyle.None)
				{
					text = CenterStyle.BorderWidth.Left.ToString();
					text2 = CenterStyle.BorderWidth.Top.ToString();
					text3 = CenterStyle.BorderWidth.Right.ToString();
					text4 = CenterStyle.BorderWidth.Bottom.ToString();
				}
