...
/// 
	...
	public class RadioButtonSkin : ButtonBaseSkin
	{
		...
		/// </summary>
		/// The checked Radio buttons image.</value>
		...
		public ImageResourceReference CheckedRadioImage
		{
			get
			{
				return GetValue("CheckedRadioImage", new ImageResourceReference(typeof(RadioButtonSkin), "Radio1.gif"));
			}
			set
			{
				SetValue("CheckedRadioImage", value);
			}
		}
		...
		/// </summary>
		/// The un checked Radio buttons image.</value>
		...
		public ImageResourceReference UnCheckedRadioImage
		{
			get
			{
				return GetValue("UnCheckedRadioImage", new ImageResourceReference(typeof(RadioButtonSkin), "Radio0.gif"));
			}
			set
			{
				SetValue("UnCheckedRadioImage", value);
			}
		}
		...
		/// </summary>
		/// The height of the radio image.</value>
		[Browsable(false)]
		[EditorBrowsable(EditorBrowsableState.Never)]
		public virtual int RadioImageHeight => GetMaxImageHeight(DefaultRadioImageHeight, UnCheckedRadioImage.ResourceName, CheckedRadioImage.ResourceName);
		...
		/// </summary>
		/// The width of the radio image.</value>
		[Browsable(false)]
		[EditorBrowsable(EditorBrowsableState.Never)]
		public int RadioImageWidth => GetMaxImageWidth(DefaultRadioImageWidth, UnCheckedRadioImage.ResourceName, CheckedRadioImage.ResourceName);
		...
		public virtual StyleValue TextNormalStyle => new StyleValue(this, "TextNormalStyle");
		...
		public virtual StyleValue TextFocusedStyle => new StyleValue(this, "TextFocusedStyle");
