...
/// 
	...
	public class OverlayedFrameStyleValueConverter : TypeConverter
	{
		...
		{
			PropertyDescriptorCollection properties = TypeDescriptor.GetProperties(typeof(OverlayedFrameStyleValue), arrAttributes);
			string[] names = new string[11]
			{
				"LeftBottomStyle", "LeftStyle", "LeftOverlayStyle", "LeftTopStyle", "TopStyle", "RightTopStyle", "RightStyle", "RightOverlayStyle", "RightBottomStyle", "BottomStyle",
				"CenterStyle"
			};
