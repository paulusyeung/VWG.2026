...
namespace Gizmox.WebGUI.Forms.Skins
{
	...
	public class ButtonSkin : ButtonBaseSkin
	{
		...
		/// </summary>
		/// The flat button normal style.</value>
		[Category("States")]
		[Description("The flat button normal style.")]
		public virtual StyleValue FlatButtonNormalStyle => new StyleValue(this, "FlatButtonNormalStyle");

		/// 
		/// Gets the flat button focused style.
		/// </summary>
		/// The flat button focused style.</value>
		[Category("States")]
		[Description("The flat button focused style.")]
		public virtual StyleValue FlatButtonFocusedStyle => new StyleValue(this, "FlatButtonFocusedStyle");

		/// 
		/// Gets the flat button hover style.
		/// </summary>
		/// The flat button hover style.</value>
		[Category("States")]
		[Description("The flat button hover style.")]
		public virtual StyleValue FlatButtonHoverStyle => new StyleValue(this, "FlatButtonHoverStyle");

		/// 
		/// Gets the flat button pressed style.
		/// </summary>
		/// The flat button pressed style.</value>
		[Category("States")]
		[Description("The flat button pressed style.")]
		public virtual StyleValue FlatButtonPressedStyle => new StyleValue(this, "FlatButtonPressedStyle");
		...
		public StyleValue DropDownArrowImageStyle => new StyleValue(this, "DropDownArrowImageStyle");

		[Browsable(false)]
		[EditorBrowsable(EditorBrowsableState.Never)]
		internal int DropDownImageWidth => GetImageSize(DropDownArrowImageStyle.BackgroundImage, Size.Empty).Width;

		[Browsable(false)]
		[EditorBrowsable(EditorBrowsableState.Never)]
		internal int DropDownImageHeight => GetImageSize(DropDownArrowImageStyle.BackgroundImage, Size.Empty).Height;
		...
		public ImageResourceReference DropDownArrowImage
		{
			get
			{
				return DropDownArrowImageStyle.BackgroundImage;
			}
			set
			{
				DropDownArrowImageStyle.BackgroundImage = value;
			}
		}
		...
		public virtual StyleValue DropDownArrowImageDisabledStyle => new StyleValue(this, "DropDownArrowImageDisabledStyle");
		...
		public virtual StyleValue ImageDisabledStyle => new StyleValue(this, "ImageDisabledStyle", ImageStyle);
		...
		public virtual StyleValue ImageStyle => new StyleValue(this, "ImageStyle");
		...
		{
			Reset("DropDownArrowImageDisabledStyle");
		}
	}
}
