...
/// 
	...
	public class ContentProperties
	{
		...
		/// </summary>
		/// 
		///   true</c> if [full screen]; otherwise, false</c>.
		/// </value>
		...
		public string ContentDescription
		{
			get
			{
				return mstrContentDescription;
			}
			set
			{
				mstrContentDescription = value;
			}
		}
		...
		public List<object> StatusData
		{
			get
			{
				return mobjStatusData;
			}
			set
			{
				mobjStatusData = value;
			}
		}
		...
		/// </value>
		public string ContentName => mstrContentName;
		...
		{
			mstrContentName = strContentName;
		}
	}
}
