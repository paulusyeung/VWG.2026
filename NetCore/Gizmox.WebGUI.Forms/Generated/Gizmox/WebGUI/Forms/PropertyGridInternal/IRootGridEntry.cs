...
namespace Gizmox.WebGUI.Forms.PropertyGridInternal
{
	...
	public interface IRootGridEntry
	{
		...
		/// The attributes on which the property browser filters.</returns>
		System.ComponentModel.AttributeCollection BrowsableAttributes { get; set; }

		/// Resets the <see cref="P:Gizmox.WebGUI.Forms.PropertyGridInternal.IRootGridEntry.BrowsableAttributes"></see> property to the default value.</summary>
		void ResetBrowsableAttributes();

		/// Sorts the properties in the property browser.</summary>
