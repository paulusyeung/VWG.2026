...
{
	/// Provides data for the <see cref="E:Gizmox.WebGUI.Forms.DataGridView.ColumnStateChanged"></see> event. </summary>
	/// 2</filterpriority>
	[Serializable]
	public class DataGridViewColumnStateChangedEventArgs : EventArgs
	{
		...
		/// Gets the column whose state changed.</summary>
		/// The <see cref="T:Gizmox.WebGUI.Forms.DataGridViewColumn"></see> whose state changed.</returns>
		/// 1</filterpriority>
		public DataGridViewColumn Column => mobjDataGridViewColumn;

		/// Gets the new column state.</summary>
		/// One of the <see cref="T:Gizmox.WebGUI.Forms.DataGridViewElementStates"></see> values.</returns>
		public DataGridViewElementStates StateChanged => menmElementStateChanged;

		/// Initializes a new instance of the <see cref="T:Gizmox.WebGUI.Forms.DataGridViewColumnStateChangedEventArgs"></see> class. </summary>
