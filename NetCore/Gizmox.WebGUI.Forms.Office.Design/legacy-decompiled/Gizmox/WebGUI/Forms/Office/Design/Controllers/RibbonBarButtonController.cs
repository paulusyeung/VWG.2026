...
public class RibbonBarButtonController : ButtonController
{
	...
	public RibbonBarButtonController(IContext objContext, object objWebObject, object objWinObject)
		: base(objContext, objWebObject, objWinObject)
	{
	}

	public RibbonBarButtonController(IContext objContext, object objWebObject)
