# Gizmox.WebGUI.Forms.Office.Design (.NET 8 Standalone Migration)

## Purpose

This project is the standalone .NET 8 migration target for the legacy `Gizmox.WebGUI.Forms.Office.Design` assembly.
...
- Main project file: `Gizmox.WebGUI.Forms.Office.Design.csproj`
