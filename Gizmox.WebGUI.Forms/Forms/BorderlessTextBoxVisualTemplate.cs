...
// Type: Gizmox.WebGUI.Forms.BorderlessTextBoxVisualTemplate
...
namespace Gizmox.WebGUI.Forms
{
  ...
  public class BorderlessTextBoxVisualTemplate : VisualTemplate
  {
    ...
    public override string VisualTemplateName => nameof (BorderlessTextBoxVisualTemplate);

    /// <summary>Gets the visualizer image.</summary>
    /// <value>The visualizer image.</value>
    public override ResourceHandle VisualizerImage => (ResourceHandle) new SkinResourceHandle(typeof (BorderlessTextBoxVisualTemplateSkin), "TextBoxBorderLess.png");
    ...
    /// </returns>
    public override string ToString() => "Borderless Display";

    /// <summary>Gets the default visual template for a given control.</summary>
    /// <param name="objControl">The object control.</param>
    /// <returns></returns>
    public override VisualTemplate GetDefault(Control objControl) => (VisualTemplate) new BorderlessTextBoxVisualTemplate();
  }
}
