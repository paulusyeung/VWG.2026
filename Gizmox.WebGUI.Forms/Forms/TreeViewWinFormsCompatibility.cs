...
// Type: Gizmox.WebGUI.Forms.TreeViewWinFormsCompatibility
...
namespace Gizmox.WebGUI.Forms
{
  ...
  public class TreeViewWinFormsCompatibility : ControlWinFormsCompatibility
  {
    ...
    {
      get => this.GetFeature(nameof (TreeNodeClickEventsOnToggle));
      set => this.SetFeature(nameof (TreeNodeClickEventsOnToggle), value);
    }
    ...
    /// </value>
    [Browsable(false)]
    public bool IsTreeNodeClickEventsOnToggle => this.GetFeatureBoolValue("TreeNodeClickEventsOnToggle");
  }
}
