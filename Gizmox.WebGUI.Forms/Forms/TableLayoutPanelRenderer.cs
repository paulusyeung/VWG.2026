...
// Type: Gizmox.WebGUI.Forms.TableLayoutPanelRenderer
...
{
  /// <summary>Provides support for rendering a groupbox control</summary>
  [EditorBrowsable(EditorBrowsableState.Never)]
  public class TableLayoutPanelRenderer : ControlRenderer
  {
    /// <summary>
    /// Initializes a new instance of the <see cref="T:Gizmox.WebGUI.Forms.TableLayoutPanelRenderer" /> class.
    /// </summary>
    ...
    public TableLayoutPanelRenderer(TableLayoutPanel objTableLayoutPanel)
      : base((Control) objTableLayoutPanel)
    {
    }
