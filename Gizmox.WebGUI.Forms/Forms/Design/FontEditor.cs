...
// Type: Gizmox.WebGUI.Forms.Design.FontEditor
...
namespace Gizmox.WebGUI.Forms.Design
{
  ...
  public class FontEditor : WebUITypeEditor
  {
    ...
    {
      FontDialog objDialog = new FontDialog();
      objDialog.Font = this.GetEditorValueFromPropertyValue(objValue) as Font;
      objDialog.Closed += new EventHandler(this.objFontDialog_Closed);
    ...
    private void objFontDialog_Closed(object sender, EventArgs e)
    {
      ...
      if (fontDialog.DialogResult != DialogResult.OK || this.mobjHandler == null)
        return;
      this.mobjHandler(this.GetPropertyValueFromEditorValue((object) fontDialog.Font));
    }
