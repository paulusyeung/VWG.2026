...
// Type: Gizmox.WebGUI.Forms.ListControlWinFormsCompatibility
...
namespace Gizmox.WebGUI.Forms
{
  ...
  public class ListControlWinFormsCompatibility : ControlWinFormsCompatibility
  {
    ...
    {
      get => this.GetFeature(nameof (ForceSelectedIndexChangedOnClick));
      set => this.SetFeature(nameof (ForceSelectedIndexChangedOnClick), value);
    }
    ...
    /// </value>
    [Browsable(false)]
    public bool IsForceSelectedIndexChangedOnClick => this.GetFeatureBoolValue("ForceSelectedIndexChangedOnClick");
  }
}
