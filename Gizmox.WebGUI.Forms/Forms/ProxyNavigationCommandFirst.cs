...
// Type: Gizmox.WebGUI.Forms.ProxyNavigationCommandFirst
...
namespace Gizmox.WebGUI.Forms
{
  ...
  public class ProxyNavigationCommandFirst : ProxyNavigationCommand
  {
    ...
    /// <returns></returns>
    public override bool DoNavigation(INavigationControl objINavigationControl) => objINavigationControl != null && objINavigationControl.MoveFirst();
    ...
    public override bool DoNavigation(IContext objContext, List<IForm> objList, Form objForm)
    {
      ...
      {
        long id = ((RegisteredComponent) objList[0]).ID;
    ...
    /// </returns>
    public override string ToString() => "Navigate First";
  }
}
