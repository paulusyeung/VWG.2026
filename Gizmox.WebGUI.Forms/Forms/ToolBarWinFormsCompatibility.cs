...
// Type: Gizmox.WebGUI.Forms.ToolBarWinFormsCompatibility
...
namespace Gizmox.WebGUI.Forms
{
  ...
  public class ToolBarWinFormsCompatibility : ControlWinFormsCompatibility
  {
    ...
    {
      get => this.GetFeature(nameof (ToolBarItemAutoSizePreservedPlaceholders));
      set => this.SetFeature(nameof (ToolBarItemAutoSizePreservedPlaceholders), value);
    }
    ...
    /// </value>
    [Browsable(false)]
    public bool IsToolBarItemAutoSizePreservedPlaceholders => this.GetFeatureBoolValue("ToolBarItemAutoSizePreservedPlaceholders");
  }
}
