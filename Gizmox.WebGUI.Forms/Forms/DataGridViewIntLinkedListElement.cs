...
// Type: Gizmox.WebGUI.Forms.DataGridViewIntLinkedListElement
...
namespace Gizmox.WebGUI.Forms
{
  ...
  internal class DataGridViewIntLinkedListElement
  {
    ...
    public DataGridViewIntLinkedListElement(int integer) => this.mintInteger = integer;

    public int Int
    {
      get => this.mintInteger;
      set => this.mintInteger = value;
    }
