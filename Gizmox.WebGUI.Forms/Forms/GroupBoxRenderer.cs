...
// Type: Gizmox.WebGUI.Forms.GroupBoxRenderer
...
namespace Gizmox.WebGUI.Forms
{
  ...
  {
    /// <summary>
    /// Initializes a new instance of the <see cref="T:Gizmox.WebGUI.Forms.GroupBoxRenderer" /> class.
    /// </summary>
    /// <param name="objGroupBox">The groupbox control.</param>
    public GroupBoxRenderer(GroupBox objGroupBox)
      : base((Control) objGroupBox)
    {
    }
