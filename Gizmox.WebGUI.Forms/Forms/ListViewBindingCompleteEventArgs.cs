...
// Type: Gizmox.WebGUI.Forms.ListViewBindingCompleteEventArgs
...
namespace Gizmox.WebGUI.Forms
{
  ...
  public class ListViewBindingCompleteEventArgs : EventArgs
  {
    ...
    public ListViewBindingCompleteEventArgs(ListChangedType enmListChangedType) => this.menmListChangedType = enmListChangedType;
