...
// Type: Gizmox.WebGUI.Forms.NativeComboBoxVisualTemplate
...
namespace Gizmox.WebGUI.Forms
{
  ...
  public class NativeComboBoxVisualTemplate : VisualTemplate
  {
    ...
    public override string VisualTemplateName => nameof (NativeComboBoxVisualTemplate);

    /// <summary>Gets the visualizer image.</summary>
    /// <value>The visualizer image.</value>
    public override ResourceHandle VisualizerImage => (ResourceHandle) new SkinResourceHandle(typeof (NativeComboBoxVisualTemplateSkin), "NativeCombo.png");
    ...
    /// </returns>
    public override string ToString() => "Native ComboBox";
  }
}
