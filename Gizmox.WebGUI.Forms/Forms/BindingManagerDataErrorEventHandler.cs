...
// Type: Gizmox.WebGUI.Forms.BindingManagerDataErrorEventHandler
...
namespace Gizmox.WebGUI.Forms
{
  ...
  public delegate void BindingManagerDataErrorEventHandler(
    object sender,
    BindingManagerDataErrorEventArgs e);
}
