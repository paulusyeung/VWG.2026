...
// Type: Gizmox.WebGUI.Forms.UpDownEventArgs
...
namespace Gizmox.WebGUI.Forms
{
  ...
  public class UpDownEventArgs : EventArgs
  {
    ...
    public UpDownEventArgs(int intButtonPushed) => this.mintButtonID = intButtonPushed;
    ...
    public int ButtonID => this.mintButtonID;
  }
}
