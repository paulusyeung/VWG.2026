...
// Type: Gizmox.WebGUI.Forms.TabPageRenderer
...
{
  /// <summary>Provides support for rendering a TabPage control</summary>
  [EditorBrowsable(EditorBrowsableState.Never)]
  public class TabPageRenderer : ControlRenderer
  {
    /// <summary>
    /// Initializes a new instance of the <see cref="T:Gizmox.WebGUI.Forms.TabPageRenderer" /> class.
    /// </summary>
    /// <param name="objTabPage">The TabPage control.</param>
    public TabPageRenderer(TabPage objTabPage)
      : base((Control) objTabPage)
    {
    }
