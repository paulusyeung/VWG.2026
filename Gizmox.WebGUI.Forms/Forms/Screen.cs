...
// Type: Gizmox.WebGUI.Forms.Screen
...
namespace Gizmox.WebGUI.Forms
{
  ...
  public class Screen
  {
    /// <summary>Related screen context</summary>
    private IContextParams mobjContextParams;

    internal Screen(IContextParams objContextParams) => this.mobjContextParams = objContextParams;
    ...
    public static Screen FromControl(Control objControl) => Screen.PrimaryScreen;
    ...
    public static Screen FromHandle(IntPtr objWindowHandle) => Screen.PrimaryScreen;
    ...
    public static Screen FromPoint(Point objPoint) => Screen.PrimaryScreen;
    ...
    public static Screen FromRectangle(Rectangle objRectangle) => Screen.PrimaryScreen;
    ...
    public static Rectangle GetBounds(Point objPoint) => Screen.PrimaryScreen.Bounds;
    ...
    /// </returns>
    public static Rectangle GetBounds(Rectangle objRectangle) => Screen.PrimaryScreen.Bounds;
    ...
    /// </returns>
    public static Rectangle GetBounds(Control objControl) => Screen.PrimaryScreen.Bounds;
    ...
    public static Rectangle GetWorkingArea(Point objPoint) => Screen.PrimaryScreen.WorkingArea;
    ...
    public static Rectangle GetWorkingArea(Rectangle objRectangle) => Screen.PrimaryScreen.WorkingArea;
    ...
    public static Rectangle GetWorkingArea(Control objControl) => Screen.PrimaryScreen.WorkingArea;

    /// <summary>Retrieves a string representing this object.</summary>
    /// <returns>A string representation of the object.</returns>
    public override string ToString() => this.GetType().Name + "[Bounds=" + this.Bounds.ToString() + " WorkingArea=" + this.WorkingArea.ToString() + " Primary=" + this.Primary.ToString() + " DeviceName=" + this.DeviceName;
    ...
    public static Screen[] AllScreens => new Screen[1]
    {
    ...
    public int BitsPerPixel => this.mobjContextParams == null ? 16 : this.mobjContextParams.ScreenColorDepth;
    ...
    public Rectangle Bounds => this.mobjContextParams == null ? new Rectangle(0, 0, 800, 600) : new Rectangle(0, 0, this.mobjContextParams.ScreenWidth, this.mobjContextParams.ScreenHeight);
    ...
    public Rectangle WorkingArea => this.mobjContextParams == null ? new Rectangle(0, 0, 800, 600) : new Rectangle(0, 0, this.mobjContextParams.ScreenAvailableWidth, this.mobjContextParams.ScreenAvailableHeight);
  }
}
