...
// Type: Gizmox.WebGUI.Forms.ColumnHeaderGroupingData
...
namespace Gizmox.WebGUI.Forms
{
  ...
  public class ColumnHeaderGroupingData : IComparer
  {
    ...
    /// <summary>
    /// Creates a new <see cref="T:Gizmox.WebGUI.Forms.ColumnHeaderGroupingData" /> instance.
    /// </summary>
    /// <param name="objListView">list view.</param>
    public ColumnHeaderGroupingData(ListView objListView) => this.mobjListView = objListView;
    ...
    public int Compare(object objObjectA, object objObjectB)
    {
      ...
      if (columnHeader1.GroupByPosition > columnHeader2.GroupByPosition)
        return 1;
      return columnHeader1.GroupByPosition < columnHeader2.GroupByPosition ? -1 : 0;
    }
    ...
    public ICollection GroupingColumns
    {
      get
      {
        ...
        {
          if (sortedColumn.GroupBy)
            groupingColumns.Add((object) sortedColumn);
        }
        return (ICollection) groupingColumns;
      }
    }
  }
}
