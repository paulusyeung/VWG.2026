...
// Type: Gizmox.WebGUI.Forms.TitleLabelVisualTemplate
...
namespace Gizmox.WebGUI.Forms
{
  ...
  public class TitleLabelVisualTemplate : VisualTemplate
  {
    ...
    public override string VisualTemplateName => nameof (TitleLabelVisualTemplate);

    /// <summary>Gets the visualizer image.</summary>
    /// <value>The visualizer image.</value>
    public override ResourceHandle VisualizerImage => (ResourceHandle) new SkinResourceHandle(typeof (TitleLabelVisualTemplateSkin), "LabelTitleTemplate.png");
    ...
    /// </returns>
    public override string ToString() => "Title label";
  }
}
