...
// Type: Gizmox.WebGUI.Forms.Skins.ButtonSkin
...
namespace Gizmox.WebGUI.Forms.Skins
{
  ...
  [Serializable]
  public class ButtonSkin : ButtonBaseSkin
  {
    ...
    [Browsable(false)]
    public new ForegroundValue Foreground => base.Foreground;
    ...
    /// <summary>Gets the flat button normal style.</summary>
    /// <value>The flat button normal style.</value>
    [Category("States")]
    [Description("The flat button normal style.")]
    public virtual StyleValue FlatButtonNormalStyle => new StyleValue((CommonSkin) this, nameof (FlatButtonNormalStyle));

    /// <summary>Gets the flat button focused style.</summary>
    /// <value>The flat button focused style.</value>
    [Category("States")]
    [Description("The flat button focused style.")]
    public virtual StyleValue FlatButtonFocusedStyle => new StyleValue((CommonSkin) this, nameof (FlatButtonFocusedStyle));

    /// <summary>Gets the flat button hover style.</summary>
    /// <value>The flat button hover style.</value>
    [Category("States")]
    [Description("The flat button hover style.")]
    public virtual StyleValue FlatButtonHoverStyle => new StyleValue((CommonSkin) this, nameof (FlatButtonHoverStyle));

    /// <summary>Gets the flat button pressed style.</summary>
    /// <value>The flat button pressed style.</value>
    [Category("States")]
    [Description("The flat button pressed style.")]
    public virtual StyleValue FlatButtonPressedStyle => new StyleValue((CommonSkin) this, nameof (FlatButtonPressedStyle));

    /// <summary>Gets the drop down arrow image style.</summary>
    [Category("States")]
    [Gizmox.WebGUI.Forms.SRDescription("The menu item image style.")]
    [DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)]
    public StyleValue DropDownArrowImageStyle => new StyleValue((CommonSkin) this, nameof (DropDownArrowImageStyle));

    [Browsable(false)]
    [EditorBrowsable(EditorBrowsableState.Never)]
    internal int DropDownImageWidth => this.GetImageSize(this.DropDownArrowImageStyle.BackgroundImage, Size.Empty).Width;

    [Browsable(false)]
    [EditorBrowsable(EditorBrowsableState.Never)]
    internal int DropDownImageHeight => this.GetImageSize(this.DropDownArrowImageStyle.BackgroundImage, Size.Empty).Height;
    ...
    {
      get => this.DropDownArrowImageStyle.BackgroundImage;
      set => this.DropDownArrowImageStyle.BackgroundImage = value;
    }

    /// <summary>Gets the drop down arrow image disabled style.</summary>
    /// <value>The drop down arrow image disabled style.</value>
    [Category("States")]
    [Description("The drop down arrow image disable style.")]
    public virtual StyleValue DropDownArrowImageDisabledStyle => new StyleValue((CommonSkin) this, nameof (DropDownArrowImageDisabledStyle));

    /// <summary>Resets the drop down arrow image disabled style.</summary>
    internal void ResetDropDownArrowImageDisabledStyle() => this.Reset("DropDownArrowImageDisabledStyle");

    /// <summary>Gets the button image disabled style.</summary>
    [Category("States")]
    [Description("The button image disabled style.")]
    public virtual StyleValue ImageDisabledStyle => new StyleValue((CommonSkin) this, nameof (ImageDisabledStyle), this.ImageStyle);

    /// <summary>Gets the button image style.</summary>
    [Category("States")]
    [Description("The button image style.")]
    public virtual StyleValue ImageStyle => new StyleValue((CommonSkin) this, nameof (ImageStyle));
  }
}
