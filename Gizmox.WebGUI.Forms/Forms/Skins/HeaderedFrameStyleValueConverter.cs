...
// Type: Gizmox.WebGUI.Forms.Skins.HeaderedFrameStyleValueConverter
...
namespace Gizmox.WebGUI.Forms.Skins
{
  ...
  public class HeaderedFrameStyleValueConverter : FrameStyleValueConverter
  {
    ...
    {
      return TypeDescriptor.GetProperties(typeof (HeaderedFrameStyleValue), arrAttributes).Sort(new string[12]
      {
        "HeaderLeftStyle",
        "HeaderCenterStyle",
        "HeaderRightStyle",
