...
// Type: Gizmox.WebGUI.Forms.Skins.RadioButtonSkin
...
{
  /// <summary>RadioButton Skin</summary>
  [ToolboxBitmap(typeof (RadioButton), "RadioButton.bmp")]
  [Serializable]
  public class RadioButtonSkin : ButtonBaseSkin
  {
    private void InitializeComponent()
    {
    }

    /// <summary>Gets or sets the checked Radio buttons image.</summary>
    /// <value>The checked Radio buttons image.</value>
    [Gizmox.WebGUI.Forms.SRDescription("The checked Radio image.")]
    [Gizmox.WebGUI.Forms.SRCategory("Images")]
    public ImageResourceReference CheckedRadioImage
    {
      get => this.GetValue<ImageResourceReference>(nameof (CheckedRadioImage), new ImageResourceReference(typeof (RadioButtonSkin), "Radio1.gif"));
      set => this.SetValue(nameof (CheckedRadioImage), (object) value);
    }

    /// <summary>Resets the checked Radio buttons image.</summary>
    private void ResetCheckedRadioImage() => this.Reset("CheckedRadioImage");

    /// <summary>Gets or sets the un checked Radio buttons image.</summary>
    /// <value>The un checked Radio buttons image.</value>
    [Gizmox.WebGUI.Forms.SRDescription("The unchecked Radio image.")]
    [Gizmox.WebGUI.Forms.SRCategory("Images")]
    public ImageResourceReference UnCheckedRadioImage
    {
      get => this.GetValue<ImageResourceReference>(nameof (UnCheckedRadioImage), new ImageResourceReference(typeof (RadioButtonSkin), "Radio0.gif"));
      set => this.SetValue(nameof (UnCheckedRadioImage), (object) value);
    }

    /// <summary>Resets the un checked Radio buttons image.</summary>
    private void ResetUnCheckedRadioImage() => this.Reset("UnCheckedRadioImage");

    /// <summary>Gets the height of the radio image.</summary>
    /// <value>The height of the radio image.</value>
    [Browsable(false)]
    [EditorBrowsable(EditorBrowsableState.Never)]
    public virtual int RadioImageHeight => this.GetMaxImageHeight(this.DefaultRadioImageHeight, this.UnCheckedRadioImage.ResourceName, this.CheckedRadioImage.ResourceName);

    /// <summary>Resets the height value</summary>
    internal void ResetRadioImageHeight() => this.Reset("RadioImageHeight");

    /// <summary>Gets default value</summary>
    protected virtual int DefaultRadioImageHeight => 13;

    /// <summary>Gets the width of the radio image.</summary>
    /// <value>The width of the radio image.</value>
    [Browsable(false)]
    [EditorBrowsable(EditorBrowsableState.Never)]
    public int RadioImageWidth => this.GetMaxImageWidth(this.DefaultRadioImageWidth, this.UnCheckedRadioImage.ResourceName, this.CheckedRadioImage.ResourceName);

    /// <summary>Resets the height value</summary>
    internal void ResetRadioImageWidth() => this.Reset("RadioImageWidth");

    /// <summary>Gets default value</summary>
    protected virtual int DefaultRadioImageWidth => 13;
    ...
    /// <value>The center normal style.</value>
    [Category("States")]
    [Description("The radio button's text normal style.")]
    public virtual StyleValue TextNormalStyle => new StyleValue((CommonSkin) this, nameof (TextNormalStyle));

    /// <summary>Gets the center focused style.</summary>
    /// <value>The center focused style.</value>
    [Category("States")]
    [Description("The radio button's text focused style.")]
    public virtual StyleValue TextFocusedStyle => new StyleValue((CommonSkin) this, nameof (TextFocusedStyle));
  }
}
