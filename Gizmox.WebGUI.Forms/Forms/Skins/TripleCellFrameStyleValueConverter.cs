...
// Type: Gizmox.WebGUI.Forms.Skins.TripleCellFrameStyleValueConverter
...
namespace Gizmox.WebGUI.Forms.Skins
{
  ...
  public class TripleCellFrameStyleValueConverter : TypeConverter
  {
    ...
    {
      return TypeDescriptor.GetProperties(typeof (TripleCellFrameStyleValue), arrAttributes).Sort(new string[3]
      {
        "LeftStyle",
        "RightStyle",
        "CenterStyle"
