...
// Type: Gizmox.WebGUI.Forms.Skins.SelectedIndicatorStyleValueConverter
...
namespace Gizmox.WebGUI.Forms.Skins
{
  ...
  public class SelectedIndicatorStyleValueConverter : TypeConverter
  {
    ...
    {
      return TypeDescriptor.GetProperties(typeof (SelectedIndicatorStyleValue), arrAttributes).Sort(new string[8]
      {
        "LeftBottomStyle",
        "LeftStyle",
        "LeftTopStyle",
