...
// Type: Gizmox.WebGUI.Forms.Skins.MarginValueConverter
  ...
  public class MarginValueConverter : TypeConverter
  {
      ...
      if (objValue is string)
      {
        ...
        if (!string.IsNullOrEmpty(str))
        {
          ...
          if (strArray.Length == 1)
            return (object) new MarginValue(new Padding(int.Parse(strArray[0])));
          if (strArray.Length == 4)
            return (object) new MarginValue(new Padding(int.Parse(strArray[0]), int.Parse(strArray[1]), int.Parse(strArray[2]), int.Parse(strArray[3])));
        }
      }
      ...
      Type objDestinationType)
    {
      ...
      if (marginValue.All != -1)
        return (object) marginValue.All.ToString();
      return (object) string.Format("{0}, {1}, {2}, {3}", (object) marginValue.Left, (object) marginValue.Top, (object) marginValue.Right, (object) marginValue.Bottom);
    }
