...
// Type: Gizmox.WebGUI.Forms.Skins.SimpleFrameStyleValueConverter
...
namespace Gizmox.WebGUI.Forms.Skins
{
  ...
  public class SimpleFrameStyleValueConverter : TypeConverter
  {
    ...
    {
      return TypeDescriptor.GetProperties(typeof (SimpleFrameStyleValue), arrAttributes).Sort(new string[3]
      {
        "LeftStyle",
        "RightStyle",
        "CenterStyle"
