...
// Type: Gizmox.WebGUI.Forms.Skins.SelectedIndicatorSizeValueConverter
...
namespace Gizmox.WebGUI.Forms.Skins
{
  ...
  public class SelectedIndicatorSizeValueConverter : TypeConverter
  {
    ...
    {
      return TypeDescriptor.GetProperties(typeof (SelectedIndicatorSizeValue), arrAttributes).Sort(new string[8]
      {
        "LeftBottomSize",
        "LeftSize",
        "LeftTopSize",
