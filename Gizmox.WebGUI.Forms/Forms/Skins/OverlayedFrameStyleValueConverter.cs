...
// Type: Gizmox.WebGUI.Forms.Skins.OverlayedFrameStyleValueConverter
...
namespace Gizmox.WebGUI.Forms.Skins
{
  ...
  public class OverlayedFrameStyleValueConverter : TypeConverter
  {
    ...
    {
      return TypeDescriptor.GetProperties(typeof (OverlayedFrameStyleValue), arrAttributes).Sort(new string[11]
      {
        "LeftBottomStyle",
        "LeftStyle",
        "LeftOverlayStyle",
