...
// Type: Gizmox.WebGUI.Forms.ListViewBindingCompleteEventHandler
...
namespace Gizmox.WebGUI.Forms
{
  ...
  public delegate void ListViewBindingCompleteEventHandler(
    object sender,
    ListViewBindingCompleteEventArgs e);
}
