...
// Type: Gizmox.WebGUI.Forms.ProxyNavigationCommandPrevious
...
namespace Gizmox.WebGUI.Forms
{
  ...
  public class ProxyNavigationCommandPrevious : ProxyNavigationCommand
  {
    ...
    /// <returns></returns>
    public override bool DoNavigation(INavigationControl objINavigationControl) => objINavigationControl != null && objINavigationControl.MovePrevious();
    ...
    /// </returns>
    public override string ToString() => "Navigate Previous";
  }
}
