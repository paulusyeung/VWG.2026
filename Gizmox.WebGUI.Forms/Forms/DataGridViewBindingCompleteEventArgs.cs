...
// Type: Gizmox.WebGUI.Forms.DataGridViewBindingCompleteEventArgs
...
namespace Gizmox.WebGUI.Forms
{
  ...
  public class DataGridViewBindingCompleteEventArgs : EventArgs
  {
    ...
    public DataGridViewBindingCompleteEventArgs(ListChangedType enmListChangedType) => this.menmListChangedType = enmListChangedType;
    ...
    public ListChangedType ListChangedType => this.menmListChangedType;
  }
}
