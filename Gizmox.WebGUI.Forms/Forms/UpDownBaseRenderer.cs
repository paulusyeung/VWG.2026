...
// Type: Gizmox.WebGUI.Forms.UpDownBaseRenderer
...
{
  /// <summary>Provides support for rendering UpDownBasees</summary>
  ...
  public class UpDownBaseRenderer : ControlRenderer
  {
    ...
    {
      if (!(this.Control is UpDownBase control))
        return;
